...
function App() {
  return (
    <>
  {/* Last Published: Sat May 25 2024 18:28:11 GMT+0000 (Coordinated Universal Time) */}
  <meta charSet="utf-8" />
  <title>
    Eduzi Academy | A Proven Program to Make You a Software Developer
  </title>
  <meta
    content="Intensive 3.0 offers multiple job tracks such as Java and MERN Full Stack, Data Analytics, and QA/Automation Testing, Start your IT career in a powerful way."
    name="description"
  />
  <meta
    content="Intensive 3.0 | A Proven Program to Make You a Software Developer"
    property="og:title"
  />
  <meta
    content="Intensive 3.0 offers multiple job tracks such as Java and MERN Full Stack, Data Analytics, and QA/Automation Testing, Start your IT career in a powerful way."
  ...
  />
  <meta
    content="https://assets-global.website-files.com/5fa61cbbf0d432b3230f62b1/63e49409e6ead652e0028716_intensive-og-image.png"
    property="og:image"
  />
  <meta
    content="Intensive 3.0 | A Proven Program to Make You a Software Developer"
  ...
  <link
    href="https://assets-global.website-files.com/5fa61cbbf0d432b3230f62b1/css/ccbp-4-0-technical-intensive-project.137d04406.min.css"
    rel="stylesheet"
    type="text/css"
  />
  ...
  />
  <link
    href="https://assets-global.website-files.com/5fa61cbbf0d432b3230f62b1/5fc099bc9d2e7a768325bbcc_Group%2030%20(2).svg"
    rel="shortcut icon"
    type="image/x-icon"
  />
  <link
    href="https://assets-global.website-files.com/5fa61cbbf0d432b3230f62b1/5fbf7a612a3ba6c0ff13455e_256X256.png"
    rel="apple-touch-icon"
  />
  <link href="https://www.ccbp.in/intensive" rel="canonical" />
  <style
  ...
  <link
    rel="preload"
    href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap&text=ABCBEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqurstuvwxyz1234567890%E2%80%98?%E2%80%99%E2%80%9C!%E2%80%9D₹(%)[#]{@}/&\%3C-+%C3%B7%C3%97=%3E%C2%AE%C2%A9$%E2%82%AC%C2%A3%C2%A5%C2%A2:;,.*"
    as="style"
    onload="this.onload=null;this.rel='stylesheet'"
  />
  {/* Google Tag Manager */}
  {/* End Google Tag Manager */}
  <meta property="og:url" content="https://www.ccbp.in/intensive" />
  {/*
<link rel="stylesheet" href=https://forms.ccbp.in/webflow/bookAFreeDemo.13f04d7dd9776178.css> */}
  <link
    rel="stylesheet"
    href="https://forms.ccbp.in/webflow/bookAFreeDemo.0a1627de4149b7d7.css"
  />
  <style
    dangerouslySetInnerHTML={{
      __html:
  ...
  />
  <div className="svg-images-container w-embed">
    <style
      dangerouslySetInnerHTML={{
        __html:
  ...
  >
        ...
        >
          <div className="container-28 intensive-2-0 w-container">
            ...
            <div className="menu-button-6 w-nav-button">
              <div className="icon-34 w-icon-nav-menu" />
            </div>
            <nav role="navigation" className="nav-menu-home-3 w-nav-menu">
              ...
              <a
                href="#"
                id="home-primary-navbar"
                className="desktop-navbar-items track-class w-nav-link"
              >
                Home
              </a>
              <a
                href="#curriculum"
                id="curriculum-primary-navbar"
                className="desktop-navbar-items track-class w-nav-link"
              >
                Curriculum
              </a>
      ...
      <div className="intensive-hero-section-div int-tce">
        <div className="new-track-div-copy">
          <div className="div-block-1831980521447265">
            <div className="text-block-9412882478">NEW</div>
          </div>
          <div className="div-block-183198052202">
            <div className="text-block-94128895-copy">
              ...
              <div className="intensive-description-div">
                <div className="div-block-183198052209">
                  <div className="w-layout-grid grid-8652">
                    <div
                      id="w-node-_15223fc5-faed-1013-6a91-6d1ea862eca5-d23a40cb"
                      className="div-block-183198052203"
                    >
                      <div className="div-block-183198052205">
                        <div className="html-embed-41917 w-embed">
                          <img
                            src="https://nxtwave.imgix.net/ccbp-website/nxtwave-intensive-2.0/course-duration-icon.png"
                            alt=""
                            loading="lazy"
                          />
                        </div>
                      ...
                      <div className="div-block-183198052204">
                        <div className="text-block-94128920">
                          Course Duration
                        </div>
                    ...
                    <div
                      id="w-node-_15223fc5-faed-1013-6a91-6d1ea862ecad-d23a40cb"
                      className="div-block-183198052203"
                    >
                      <div className="div-block-183198052205">
                        <div className="html-embed-41917 w-embed">
                          <img
                            src="https://nxtwave.imgix.net/ccbp-website/nxtwave-intensive-2.0/eligibility-icon.png"
                            alt=""
                            loading="lazy"
                          />
                        </div>
                    ...
                    <div
                      id="w-node-_15223fc5-faed-1013-6a91-6d1ea862ecb5-d23a40cb"
                      className="div-block-183198052203"
                    >
                      <div className="div-block-183198052205">
                        <div className="html-embed-41917 w-embed">
                          <img
                            src="https://nxtwave.imgix.net/ccbp-website/nxtwave-intensive-2.0/online-icon.png"
                            alt=""
                            loading="lazy"
                          />
                        </div>
                    ...
                    <div
                      id="w-node-_5efd8d37-e4b1-deea-a5d4-2de8bd831354-d23a40cb"
                      className="div-block-1831980521447044"
                    >
                      <div className="div-block-1831980521447045">
                        <div className="html-embed-82605 w-embed">
                          <img
                            src="https://nxtwave.imgix.net/ccbp-website/intensive/live-sessions-icon-referral.png"
                            alt=""
                            loading="lazy"
                          />
                        </div>
                  ...
                  <div className="fee-increase-strip pricing">
                    <div className="text-block-94128877">
                      Fee increases from March 31st
                    </div>
                    <img
                      src="https://assets-global.website-files.com/5fa61cbbf0d432b3230f62b1/63d50e0656bafb711a8de818_fee-increase-strip-image.svg"
                      loading="lazy"
                      alt=""
                      className="image-8730082"
                    />
                    <img
                      src="https://assets-global.website-files.com/5fa61cbbf0d432b3230f62b1/63d50e24050b7658779c93b3_trending-up.png"
                      loading="lazy"
                      alt=""
                      className="image-8730083 strip-up"
                    />
                  </div>
                </div>
                <div className="div-block-183198052156">
                  <div
                    data-delay={4000}
                    data-animation="slide"
                    className="hs-testimonials-slider-v1-2 w-slider"
                    data-autoplay="true"
                    data-easing="ease"
                  ...
                  >
                    ...
                    <div className="w-slider-nav" />
                  </div>
                </div>
                <div className="div-block-183198052211">
      ...
      <div id="book-a-free-demo-intensive" className="scholarship-form">
        <form style={{
          ...
          <div style={{ marginBottom: '15px' }}>
            ...
            <input type="tel" id="whatsapp" name="whatsapp" style={{
              width: '100%',
              padding: '10px',
              border: '1px solid #ddd',
              borderRadius: '5px'
        ...
        <div className="image-8730088-copy w-embed">
          <img
            src="https://nxtwave.imgix.net/ccbp-website/intensive/vector.png"
            loading="lazy"
            alt="vector"
          />
        </div>
        <div className="div-block-183198052211 desktop">
          <div className="text-block-94128923">Product of</div>
          <div className="html-embed-41921 w-embed">
            <img
    ...
    <div id="course-details" className="div-block-183198052221">
      <div className="div-block-183198052209 desktop">
        <div className="w-layout-grid grid-8652">
          <div
            id="w-node-d6aa8992-a836-8aea-3ccd-b98bd26c1b2d-d23a40cb"
            className="div-block-183198052203"
          >
            <div className="div-block-183198052205">
              <div className="html-embed-41917 w-embed">
          ...
          <div
            id="w-node-d6aa8992-a836-8aea-3ccd-b98bd26c1b35-d23a40cb"
            className="div-block-183198052203"
          >
            <div className="div-block-183198052205">
              <div className="html-embed-41917 w-embed">
          ...
          <div
            id="w-node-d6aa8992-a836-8aea-3ccd-b98bd26c1b3f-d23a40cb"
            className="div-block-183198052203"
          >
            <div className="div-block-183198052205">
              <div className="html-embed-41917 w-embed">
          ...
          <div
            id="w-node-_15cebc3a-fb2f-f35f-776d-c6b55b2e8277-d23a40cb"
            className="div-block-1831980521447044"
          >
            <div className="div-block-1831980521447045">
              <div className="html-embed-82605 w-embed">
  ...
  <div id="intensive-upgrades" data-sectionid="sections" className="expanded">
    ...
    >
      ...
      <div className="down-arrow-icon-2 w-embed">
        <img
  ...
  <section
    ...
    data-sectionid="sections"
    className="section-2648"
  >
    <div className="learn-the-best-section w-container">
      <div className="best-alumni-div-2">
        ...
        <div className="html-embed-41935 w-embed">
          <img
            src="https://nxtwave.imgix.net/ccbp-website/intensive/learn-the-best-from-the-alumni/alumni-mobile.png"
            alt="test image"
            width="100%"
            loading="lazy"
          />
        </div>
        <p className="home-many-more-2">and many more...</p>
      </div>
    </div>
  </section>
  <div id="reviews" data-sectionid="sections" className="section-2674">
    <div className="div-block-1831980521447038 intensive-2-0-page">
      ...
      <div className="div-block-1831980521447033">
        <div
          data-current="Tab 1"
          data-easing="ease"
          data-duration-in={300}
          data-duration-out={100}
          className="tabs-37 w-tabs"
        >
          <div className="tab-menu-categories w-tab-menu">
            <a
              data-w-tab="Tab 1"
              id="all-tab-reviews"
              className="categories-tab track-button w-inline-block w-tab-link w--current"
            >
              <div>All</div>
            </a>
            <a
              data-w-tab="Tab 2"
              id="non-it-branch-to-it-job-tab-reviews"
              filter-by="Top MNC Companies"
              className="categories-tab track-button w-inline-block w-tab-link"
            >
              <div className="text-block-9412882400">
                Non IT Branch to IT Job
              </div>
            </a>
            <a
              data-w-tab="Tab 4"
              id="non-engineering-degree-tab-reviews"
              filter-by="Women in tech"
              className="categories-tab track-button w-inline-block w-tab-link"
            >
              <div className="text-block-9412882401">
                Non-Engineering Degree
              </div>
            </a>
            <a
              data-w-tab="Tab 9"
              id="career-gap-tab-reviews"
              className="categories-tab track-button w-inline-block w-tab-link"
            >
              <div className="text-block-9412882398">Career Gap</div>
            </a>
            <a
              data-w-tab="Tab 6"
              id="got-into-top-mncs-tab-reviews"
              className="categories-tab track-button w-inline-block w-tab-link"
            >
              <div className="text-block-9412882399">Got Into Top MNCs</div>
            </a>
            <a
              data-w-tab="Tab 10"
              id="non-it-job-to-it-job-tab-reviews"
              className="categories-tab track-button w-inline-block w-tab-link"
            >
              <div className="text-block-9412882402">Non IT job to IT job</div>
            </a>
          </div>
          <div className="w-tab-content">
            <div data-w-tab="Tab 1" className="w-tab-pane w--tab-active">
              <div className="div-block-1831980521447037">
                <div className="w-embed">
                  <style
                    dangerouslySetInnerHTML={{
                      __html:
                ...
                >
                  <div className="mask-67 w-slider-mask">
                    <div className="slide-115 w-slide">
                      <div
                        id="testimonial-card-user-stories"
                        className="div-block-1831980521447039 all intensive"
                      >
                    ...
                    <div className="slide-115 w-slide">
                      ...
                      >
                        ...
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            I got tremendous placement support which never left
                            my hand until I got placed.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Sravan Tangudu</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/sravan-tangudu.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            CCBP 4.0 trained me with all the required skills to
                            get a software job.
                          </div>
                        </div>
                      </div>
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            ...
                            <div className="user-college-v">
                              VKR, VNB and AGK College of Engineering, Gudivada
                            </div>
                            <div className="text-block-9412882397">
                              2020 Graduate
                            </div>
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/naga-sai-yeswanth.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            CCBP 4.0 provides a well-structured curriculum and a
                            clear learning path.
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Renuka</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/renuka.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            The practical skills I gained in CCBP 4.0 helped me
                            get placed in a giant MNC.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Sushma</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/sushma.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            Project-based learning made me get practical
                            knowledge though I started from zero.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Vikram</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/vikram.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          <div loading="lazy" className="blue-down-arrow" />
                          <div className="designation-field-v">
                            Software Development Engnieer - I
                          </div>
                          <div className="html-embed-82597 w-embed">
                            <div
                              style={{
                          ...
                          <div className="highlighted-text-v">
                            I understood all the concepts easily as the sessions
                            were in my mother tongue.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Sivaram</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/sivaram.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            Though I started with CCBP 4.0 as a newbie, I got
                            placed in a renowned product-based company.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Prabhu Kishore</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                            ...
                            <div className="user-college-v">K L University</div>
                            <div className="text-block-9412882397">
                              2020 Graduate
                            </div>
                          </div>
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/prabhu-kishore.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            The expertise of trainers in CCBP 4.0 helped me gain
                    ...
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Sravan Kumar</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/sravan-kumar.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            With the skill set I developed here, I got two offer
                    ...
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Rohith Kumar</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/rohith-kumar.avif"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            CCBP 4.0's project-based learning made me more
                            passionate to learn coding.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Srilekha</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/srilekha.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            Besides gaining tech skills, the CCBP 4.0 team
                            enhanced my interview skills
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Sravanthi</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/sravanthi.avif"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            With CCBP 4.0's level of training, anyone can learn
                            easily and get into IT.
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div
                    id="left-arrow-all-tab-reviews"
                    className="left-arrow-12376 track-class w-slider-arrow-left"
                  >
                    <div
                      loading="lazy"
                      className="your-seniors-got-placed-left-arrow"
                    />
                  </div>
                  <div
                    id="right-arrow-all-tab-reviews"
                    className="right-arrow-2186 track-class w-slider-arrow-right"
                  >
                    <div
                      loading="lazy"
                      className="your-seniors-got-placed-right-arrow"
                    />
                  </div>
                  <div className="slide-nav-70 w-slider-nav" />
                </div>
              </div>
            </div>
            <div data-w-tab="Tab 2" className="w-tab-pane">
              <div className="div-block-1831980521447037">
                ...
                >
                  <div className="mask-67 w-slider-mask">
                    ...
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Satya Prashanth</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/satya-prashanth.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            Attending sessions in my native language helped me
                    ...
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Sreemurthy Gari</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/sreemurthy-gari.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            I built strong tech skills by learning each concept
                            from scratch
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Abhishek</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/abhishek-vastar.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            The well-curated practice tests helped me gain
                            practical skills and crack the interview.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/yaswanth-teja-rao.avif"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            I learned concepts clearly and got real-time
                            projects, mock tests, assignments, etc.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Shailesh</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/shailesh.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            With the trainer’s crystal clear explanations, I
                            understood all the concepts clearly.
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div
                    id="left-arrow-non-it-branch-to-it-job-tab-reviews"
                    className="left-arrow-12376 track-class w-slider-arrow-left"
                  >
                    <div
                      loading="lazy"
                  ...
                  <div
                    id="right-arrow-non-it-branch-to-it-job-tab-reviews"
                    className="right-arrow-2186 track-class w-slider-arrow-right"
                  >
                    <div
                      loading="lazy"
            ...
            <div data-w-tab="Tab 4" id="non-engineering" className="w-tab-pane">
              <div className="div-block-1831980521447037">
                <div
                  data-delay={4000}
                  data-animation="slide"
                ...
                >
                  <div className="mask-67 w-slider-mask">
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Nandini Varma</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                            ...
                            <div className="user-college-v">
                              Deeksha Degree College &amp; PG Centre
                            </div>
                          </div>
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/nandini-varma.avif"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            Joining CCBP 4.0 changed my life. At the age of 21
                            years, I got placed in a top MNC.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Srivalli</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                            ...
                            <div className="user-college-v">
                              Acharya N G Rang Agricultural University
                            </div>
                          </div>
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/p-srivalli.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="html-embed-82597 w-embed">
                            ...
                            >
                              <img
                                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/reviews/company-logos/cgi.png"
                                className="company-img"
                                loading="lazy"
                              />
                            </div>
                          ...
                          <div className="highlighted-text-v">
                            The placement team provided me with ample
                            opportunities and guided me to ace the interviews.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Lahari</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                            ...
                            <div className="user-college-v">
                              Osmania Universityhnology
                            </div>
                          </div>
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/lahari-balabhadra.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="html-embed-82597 w-embed">
                            ...
                            >
                              <img
                                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/reviews/company-logos/collabera.png"
                                className="company-img"
                                loading="lazy"
                              />
                            </div>
                          ...
                          <div className="highlighted-text-v">
                            I cracked a tech job 4 times my previous salary with
                            the practical skills I built at CCBP 4.0.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Naga Aruna</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/venkata-naga-aruna-addanki.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="html-embed-82597 w-embed">
                            ...
                            >
                              <img
                                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/reviews/company-logos/msys-technologies-v1.png"
                                className="company-img"
                                loading="lazy"
                              />
                            </div>
                          ...
                          <div className="highlighted-text-v">
                            The placement support team of CCBP 4.0 encouraged
                            and handheld me until I got placed.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Saisiva</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/dandu-saisiva.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            I built strong tech foundations effortlessly from
                            zero programming knowledge with CCBP 4.0.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/upendar-jetteboina.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            I began my IT career as a Software Engineer by
                            building industry-ready skills from scratch.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Dhana Girija</div>
                            <div className="user-college-v">
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/lanke-dhana-girija-pal-chandra.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="html-embed-82597 w-embed">
                            ...
                            >
                              <img
                                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Reviews/company-logos/systech-v1.png"
                                className="company-img"
                                loading="lazy"
                              />
                            </div>
                          ...
                          <div className="highlighted-text-v">
                            I gained practical exposure at CCBP 4.0 and became
                            industry-ready at a remarkable pace
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Surya Chandra</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/indukuri-surya-chandra-varma.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            I landed an IT job as I developed strong tech
                            foundations at a faster pace with CCBP 4.0.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Sonali</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/sonali-kothapalli.avif"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            Practice sets &amp; coding assignments enhanced my
                            practical skills to build strong foundations.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Murali Krishna</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/murali-krishna-yernena.avif"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="html-embed-82597 w-embed">
                            ...
                            >
                              <img
                                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/reviews/company-logos/career360.avif"
                                className="company-img"
                                loading="lazy"
                              />
                            </div>
                          ...
                          <div className="highlighted-text-v">
                            CCBP 4.0 provided me with a solid foundation in tech
                            skills for building my IT career.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/naveen-nagarjunapu.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="html-embed-82597 w-embed">
                            ...
                            >
                              <img
                                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Reviews/company-logos/abjayon-v1.png"
                                className="company-img"
                                loading="lazy"
                              />
                            </div>
                          ...
                          <div className="highlighted-text-v">
                            The intuitive teaching support and unmatched
                            placement support helped me secure an IT job.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/venkata-sai-kiran-bhamidipati.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="html-embed-82597 w-embed">
                            ...
                            >
                              <img
                                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/reviews/company-logos/enlume.svg"
                                className="company-img"
                                loading="lazy"
                              />
                            </div>
                          ...
                          <div className="highlighted-text-v">
                            Coding practices helped me to code in many ways and
                            I cracked interviews effortlessly.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Nitesh Ranjan</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                              Maths, Chemistry and Computer Applications
                            </div>
                            <div className="user-college-v">
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/nitesh-ranjan-mohanty.avif"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="html-embed-82597 w-embed">
                            ...
                            >
                              <img
                                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/reviews/company-logos/caprusit.png"
                                className="company-img"
                                loading="lazy"
                              />
                            </div>
                          ...
                          <div className="highlighted-text-v">
                            NxtWave CCBP 4.0 is a one-stop platform to learn,
                            practice, and build web applications.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Satyasai</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/satyasai-satyavarapu.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            By consistently following the schedule, I gained
                            in-depth practical skills in programming.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Mallika</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/nakka-mallika.avif"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="html-embed-82597 w-embed">
                            ...
                            >
                              <img
                                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Reviews/company-logos/acheron-v1.png"
                                className="company-img"
                                loading="lazy"
                              />
                            </div>
                          ...
                          <div className="highlighted-text-v">
                            I'm the first girl in my village to become an IT
                            professional. All thanks to CCBP 4.0!
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div
                    id="left-arrow-non-engineering-degree-tab-reviews"
                    className="left-arrow-12376 track-class w-slider-arrow-left"
                  >
                    <div
                      loading="lazy"
                  ...
                  <div
                    id="right-arrow-non-engineering-degree-tab-reviews"
                    className="right-arrow-2186 track-class w-slider-arrow-right"
                  >
                    <div
                      loading="lazy"
            ...
            <div data-w-tab="Tab 9" className="w-tab-pane">
              <div className="div-block-1831980521447037">
                ...
                >
                  <div className="mask-67 w-slider-mask">
                    ...
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Madhu</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/madhu.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            With practice tests, I gained in-depth practical
                            knowledge and built applications on my own.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Kiranmai</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/kiranmai.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            Despite a career gap, NxtWave helped me gain skills
                            and confidence to land an IT job.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Ravindra Swamy</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/ravindra-swamy.avif"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            Learning in my native language at CCBP 4.0 helped me
                    ...
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Mouli</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/mouli.avif"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            NxtWave’s continuous support and guidance helped me
                            to secure a tech job at Deloitte.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Hussain</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/hussain.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            Code practice sets and hands-on projects here helped
                            me gain in-depth tech knowledge.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Subhash</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/subhash.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            Learning from scratch and in my native language
                            helped me understand concepts well.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Pavan Kumar</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/pavan-kumar.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            Attending the sessions in my native language helped
                            me build strong tech foundations.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Sumanth</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/sumanth.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="html-embed-82597 w-embed">
                            ...
                            >
                              <img
                                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/reviews/company-logos/wipro-company-v1.png"
                                className="company-img"
                                loading="lazy"
                              />
                            </div>
                          ...
                          <div className="highlighted-text-v">
                            At CCBP 4.0, I learned to program from the basics
                            and developed a growth mindset.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Gnaneshwar</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/gnaneshwar.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            The placement team's assistance improved my
                            interview skills and landed me an IT job.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Bharath Chandra</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/Reviews/profile-images/bharath-chandra.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            Right from teaching to placement, CCBP 4.0 team gave
                            their 100%.
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Umamaheswari</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/umamaheswari-vuppuluri.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="html-embed-82597 w-embed">
                            ...
                            >
                              <img
                                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/reviews/company-logos/exl-service.png"
                                className="company-img"
                                loading="lazy"
                              />
                            </div>
                          ...
                          <div className="highlighted-text-v">
                            The mock interviews helped me gain confidence to
                            perform exceptionally well in the interview.
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div
                    id="left-arrow-career-gap-tab-reviews"
                    className="left-arrow-12376 track-class w-slider-arrow-left"
                  >
                    <div
                      loading="lazy"
                  ...
                  <div
                    id="right-arrow-career-gap-tab-reviews"
                    className="right-arrow-2186 track-class w-slider-arrow-right"
                  >
                    <div
                      loading="lazy"
            ...
            <div data-w-tab="Tab 6" className="w-tab-pane">
              <div className="div-block-1831980521447037">
                ...
                >
                  ...
                  <div
                    id="left-arrow-got-into-top-mncs-tab-reviews"
                    className="left-arrow-12376 track-class w-slider-arrow-left"
                  >
                    <div
                      loading="lazy"
                  ...
                  <div
                    id="right-arrow-got-into-top-mncs-tab-reviews"
                    className="right-arrow-2186 track-class w-slider-arrow-right"
                  >
                    <div
                      loading="lazy"
            ...
            <div data-w-tab="Tab 10" className="w-tab-pane">
              <div className="div-block-1831980521447037">
                ...
                >
                  <div className="mask-67 w-slider-mask">
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Naga Thulasi</div>
                            <div className="user-college-v">
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/mummidi-naga-thulasi.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="html-embed-82597 w-embed">
                            ...
                            >
                              <img
                                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/reviews/company-logos/continueserve.png"
                                className="company-img"
                                loading="lazy"
                              />
                            </div>
                          ...
                          <div className="highlighted-text-v">
                            Learning in my native language with real-time
                            examples made me understand everything.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/kiran-teja-kandiboyina-kloudworx-l.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="html-embed-82597 w-embed">
                            ...
                            >
                              <img
                                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/reviews/company-logos/kloudworx.png"
                                className="company-img"
                                loading="lazy"
                              />
                            </div>
                          ...
                          <div className="highlighted-text-v">
                            NxtWave is the best platform to turn your zero tech
                            skills into advanced ones
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Abdul Sathar</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/shaik-abdul-sathar.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="html-embed-82597 w-embed">
                            ...
                            >
                              <img
                                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/reviews/company-logos/probe-information.png"
                                className="company-img"
                                loading="lazy"
                              />
                            </div>
                          ...
                          <div className="highlighted-text-v">
                            I had to work as a delivery boy. But now I have
                            become a Software Engineer with CCBP 4.0.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Lakshmana Sai</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/kommula-lakshmana-sai.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="html-embed-82597 w-embed">
                            ...
                            >
                              <img
                                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/reviews/company-logos/smartforce-it-solutions.png"
                                className="company-img"
                                loading="lazy"
                              />
                            </div>
                          ...
                          <div className="highlighted-text-v">
                            After every session, mock tests and assignments
                            helped me gain practical tech skills.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Praneeth</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/praneeth.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="html-embed-82597 w-embed">
                            ...
                            >
                              <img
                                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/reviews/company-logos/valuefy.png"
                                className="company-img"
                                loading="lazy"
                              />
                            </div>
                          ...
                          <div className="highlighted-text-v">
                            With practice tests &amp; assignments after each
                            session, I gained clarity of concepts.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/kirankumar-daddala-deloitte-d.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="highlighted-text-v">
                            I joined with zero tech skills. But with NxtWave, I
                            cracked a tech job in just 5 months
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Sai Rakesh Puli</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                            ...
                            <div className="user-college-v">
                              Daita Madhusudana Sastry Sri Venkateswara Hindu
                              College of Engineering, Machilipatnam
                            </div>
                          </div>
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/standard-photo.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          <div className="blue-down-arrow" />
                          <div className="designation-field-v">SDE-1</div>
                          <div className="html-embed-82597 w-embed">
                            <div
                              style={{
                                display: "flex",
                            ...
                            >
                              <img
                                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/reviews/company-logos/tynybay.png"
                                className="company-img"
                                loading="lazy"
                              />
                            </div>
                          ...
                          <div className="highlighted-text-v">
                            NxtWave made my transition smooth from a non-tech
                            employee to a tech employee!
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Hritik Behare</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                            ...
                            <div className="user-college-v">
                              Sinhgad Technical Education Societys Sinhgad
                              Academy of Engineering, Kondhawa
                            </div>
                          </div>
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/hritik-behare-novatech-i.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="html-embed-82597 w-embed">
                            ...
                            >
                              <img
                                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/reviews/company-logos/novatech.png"
                                className="company-img"
                                loading="lazy"
                              />
                            </div>
                          ...
                          <div className="highlighted-text-v">
                            I shifted towards tech, built relevant skills with
                            NxtWave and I’m now earning 3x my previous salary.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Shiva Kumar</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/shiva-kumar-vanam-unifo-solutions-ac.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="html-embed-82597 w-embed">
                            ...
                            >
                              <img
                                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/reviews/company-logos/unifo-solutions.png"
                                className="company-img"
                                loading="lazy"
                              />
                            </div>
                          ...
                          <div className="highlighted-text-v">
                            I entered with zero tech skills and came out with a
                            tech job in my hands.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Swathi</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/swathi-kc-gss-ah.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="html-embed-82597 w-embed">
                            ...
                            >
                              <img
                                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/reviews/company-logos/giridhara-software-services.png"
                                className="company-img"
                                loading="lazy"
                              />
                            </div>
                          ...
                          <div className="highlighted-text-v">
                            Despite my non-tech background, I managed to stand
                    ...
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/sreenath-yekabote-acel-solutions.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="html-embed-82597 w-embed">
                            ...
                            >
                              <img
                                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/reviews/company-logos/acel-solutions.png"
                                className="company-img"
                                loading="lazy"
                              />
                            </div>
                          ...
                          <div className="highlighted-text-v">
                            I’m finally doing what I love, thanks to CCBP 4.0!
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Mahesh Kalagoni</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/mahesh-kalagoni-streamline-n.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="html-embed-82597 w-embed">
                            ...
                            >
                              <img
                                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/reviews/company-logos/streamline-company.png"
                                className="company-img"
                                loading="lazy"
                              />
                            </div>
                          ...
                          <div className="highlighted-text-v">
                            I became 5/5 in coding with NxtWave advanced
                            training.
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Kalyan</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/challagali-kalyan.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="html-embed-82597 w-embed">
                            ...
                            >
                              <img
                                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Reviews/company-logos/napier-health-care-v1.png"
                                className="company-img"
                                loading="lazy"
                              />
                            </div>
                          ...
                          <div className="highlighted-text-v">
                            At NxtWave, I built practical tech skills through
                            practice sets and real-world projects.
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="slide-115 w-slide">
                      ...
                      >
                        <div className="div-block-1831980521447036">
                          <div className="div-block-1831980521447034">
                            <div className="name-field-v">Madhu Mudiraj</div>
                            <div
                              fs-cmsfilter-field="branch"
                              className="user-branch-v"
                            >
                          ...
                          <div className="html-embed-82598 w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/reviews/profile-images/kolthuru-madhu-mudiraj.png"
                              loading="lazy"
                            />
                          </div>
                        </div>
                        <div className="div-block-1831980521447035">
                          ...
                          <div className="html-embed-82597 w-embed">
                            ...
                            >
                              <img
                                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/reviews/company-logos/crestere.io.png"
                                className="company-img"
                                loading="lazy"
                              />
                            </div>
                          ...
                          <div className="highlighted-text-v">
                            Everything here, from sessions to practice tests,
                            helped me clear the tech interview.
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div
                    id="left-arrow-non-it-job-to-it-job-tab-reviews"
                    className="left-arrow-12376 track-class w-slider-arrow-left"
                  >
                    <div
                      loading="lazy"
                  ...
                  <div
                    id="right-arrow-non-it-job-to-it-job-tab-reviews"
                    className="right-arrow-2186 track-class w-slider-arrow-right"
                  >
                    <div
                      loading="lazy"
        ...
        <div role="list" className="w-dyn-items">
          <div role="listitem" className="w-dyn-item">
            <div className="date-changes-cms-collection-container-your-reviews">
              <div className="intensive-batch-details-div-your-seniors">
              ...
              <div className="dates-changing-ctas">
                <div className="embed-btn w-embed">
                  <a
                    id="enroll-now-your-seniors-got-placed"
                    href="#pricing"
                ...
                <a
                  id="view-all-reviews-your-seniors-got-placed"
                  href="https://www.ccbp.in/reviews"
                  target="_blank"
                  className="text-link-block track-class w-inline-block"
                >
  ...
  <div
    id="get-ready-for-your-it-career-in-three-steps"
    data-sectionid="sections"
    className="get-ready-3-steps"
  >
    <div id="curriculum" className="section-2647 cc-no-padding-bottom">
      <div className="div-block-1831980521256" />
      <div className="container-30 cc-flex-h">
                ...
                <div role="listitem" className="w-dyn-item">
                  <div className="date-changes-cms-collection-container-intensive left-aligin pt-0">
                    ...
                    <div className="embed-btn w-embed">
                      <div className="dates-changing-ctas">
                        <a
                          id="enroll-now-your-it-career-in-3-steps-desktop"
                          href="#pricing"
                          className="book-a-free-demo-main-btn track-class w-button"
                        >
                          Enroll Now
        ...
        <div className="col-right">
          <div className="div-right">
            <div className="div-block-18319715">
              <div id="fundamentals" className="div-block-183198052218">
                <div className="fundamentals-div">
                  <div className="div-block-183198052182 step1">
                  ...
                  <div className="div-block-183198052181">
                    ...
                    <div className="div-block-183198052172">
                      <div className="html-embed-41907 w-embed">
                        <img
                          ...
                          alt="Clarify your doubts by Domain Experts"
                          width="100%"
                          loading="lazy"
                        />
                      </div>
                    ...
                    <div>
                      <div className="w-layout-grid grid-8654">
                        <div
                          ...
                          className="div-block-183198052173"
                        >
                          <div className="div-block-183198052174">
                            <div className="html-embed-41908 w-embed">
                              <img
                            ...
                            <div className="text-block-94128905">HTML</div>
                          </div>
                        </div>
                        <div
                          id="w-node-c361e8f0-dd88-f325-cfe8-e334e5b66a21-d23a40cb"
                          className="div-block-183198052173"
                        >
                          <div className="div-block-183198052174">
                            <div className="html-embed-41908 w-embed">
                            ...
                            <div className="text-block-94128905">CSS</div>
                          </div>
                        </div>
                        <div
                          id="w-node-c361e8f0-dd88-f325-cfe8-e334e5b66a26-d23a40cb"
                          className="div-block-183198052173"
                        >
                          <div className="div-block-183198052174">
                            <div className="html-embed-41908 w-embed">
                            ...
                            <div className="text-block-94128905">Python</div>
                          </div>
                        </div>
                        <div
                          id="w-node-c361e8f0-dd88-f325-cfe8-e334e5b66a2b-d23a40cb"
                          className="div-block-183198052173"
                        >
                          <div className="div-block-183198052174">
                            <div className="html-embed-41908 w-embed">
                            ...
                            <div className="text-block-94128905">SQL</div>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div
                      ...
                      data-infinite="true"
                    >
                      <div className="mask-43 w-slider-mask">
                        ...
                        <div className="slide-83 w-slide">
                          <div className="slider-image w-embed">
                            <img
                              src="https://nxtwave.imgix.net/ccbp-website/intensive/slider-fundamenatils-image.png"
                              alt=""
                              width="100%"
                              loading="lazy"
                            />
                      ...
                      <div className="left-arrow-12356 w-slider-arrow-left">
                        <div className="w-icon-slider-left" />
                      </div>
                      <div className="right-arrow-2169 w-slider-arrow-right">
                ...
                <div id="choose-your-job-track" className="div-1234">
                  <div className="div-block-183198052182 step2">
                    <div className="text-block-94128911">2</div>
                  </div>
              ...
              <div id="job-support" className="div-1234">
                <div className="div-block-183198052182 step-3">
                  <div className="text-block-94128911">3</div>
                </div>
                <div className="div-block-183198052184">
                  <div className="text-block-9412881916">
                  ...
                  <div>
                    ...
                    <div className="div-block-183198052179">
                      <div className="div-block-183198052178 div23">
                        <div className="html-embed-41912 w-embed">
                          <img
                      ...
                      <div className="ai-powered-mi-div div23">
                        <div className="html-embed-41912 w-embed">
                          <img
                    ...
                    <div className="div-block-183198052223">
                      <div className="div-block-183198052178 div23">
                        <div className="html-embed-41912 w-embed">
                          <img
                      ...
                      <div className="div-block-183198052178 div23">
                        <div className="html-embed-41912 w-embed">
                          <img
                            src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/nxtwave-intensive-2.0/access-placement-corner.png"
                            alt=""
                            width="100%"
                            loading="lazy"
                          />
              ...
              <div className="div-block-183198052217">
                <div
                  ...
                  data-infinite="true"
                >
                  <div className="mask-48 w-slider-mask">
                    <div className="slide-73 w-slide">
                      <div className="html-embed-41925 w-embed">
                        <img
                  ...
                  <div
                    id="placement-support-left-arrow"
                    className="left-arrow-107 w-slider-arrow-left"
                  />
                  <div
                    id="placement-support-right-arrow"
                    className="right-arrow-2168 w-slider-arrow-right"
                  />
              ...
              <div role="listitem" className="w-dyn-item">
                <div className="date-changes-cms-collection-container-intensive">
                  ...
                  <div className="embed-btn w-embed">
                    <div className="dates-changing-ctas">
                      <a
                        id="enroll-now-your-it-career-in-3-steps-mobile"
                        href="#pricing"
                        className="book-a-free-demo-main-btn track-class w-button"
                      >
                        Enroll Now
                      ...
                      <a
                        style={{ display: "block" }}
                        id="book-a-free-demo-your-it-career-in-3-steps-mobile"
                        href="#hero-section"
                        className="book-a-free-demo-main-btn secondary-cta-btn highlight-btn track-class w-button"
                      >
                        Book a Free Demo
  ...
  >
    ...
    <div id="doubts-clarification" className="doubts-clarified-section-bg">
      <div className="doubts-clarified-container">
        ...
        <div className="dc-bafd-container">
          <div className="dc-bafb-img-container">
            <div className="dc-bafd-illustartion w-embed">
              <img
          ...
          <div className="dc-bafd-info-container">
            <div className="dc-bafd-info-h">
              1500<span className="text-span-160">+</span> Mentors to Resolve
              Your Doubts
            </div>
            <div className="dc-bafd-info-info">
              Including Subject Matter Experts, IITians, Teaching Assistants,
              NxtWave Alumni, etc.
            </div>
            <div className="dc-bafd-cta-container desktop">
              <div className="collection-list-wrapper-4 show w-dyn-list">
                <div role="list" className="w-dyn-items">
                  <div role="listitem" className="w-dyn-item">
                    <div className="embed-btn w-embed">
                      <div className="dates-changing-ctas">
                        <a
                          id="enroll-now-doubts-clarification-desktop"
                          href="#pricing"
                          className="book-a-free-demo-main-btn track-class w-button"
                        >
                          Enroll Now
                        ...
                        <a
                          style={{ display: "block" }}
                          href="#hero-section"
                          id="book-a-free-demo-doubts-clarification-desktop"
                          className="book-a-free-demo-main-btn secondary-cta-btn highlight-btn track-class w-button"
                        >
                          Book a Free Demo
                        </a>
        ...
        <div className="dc-td-container">
          <div className="dc-td-info-container">
            <div className="dc-td-info-h">1000+ Doubts</div>
            <div className="dc-td-info-info-1">are resolved within</div>
            <div className="dc-td-info-info-2">15 minutes Everyday !</div>
            <div className="underline-yellow" />
          </div>
          <div className="dc-td-img-container">
            <div className="dc-td-illustration w-embed">
              <img
            ...
            <div role="listitem" className="w-dyn-item">
              <div className="date-changes-cms-collection-container-intensive">
                ...
                <div className="embed-btn w-embed">
                  <div className="dates-changing-ctas">
                    <a
                      id="enroll-now-doubts-clarification-mobile"
                      href="#pricing"
                      className="book-a-free-demo-main-btn track-class w-button"
                    >
                      Enroll Now
                    ...
                    <a
                      style={{ display: "block" }}
                      id="book-a-free-demo-doubts-clarification-mobile"
                      href="#hero-section"
                      className="book-a-free-demo-main-btn secondary-cta-btn highlight-btn track-class w-button"
                    >
                      Book a Free Demo
  ...
  <div
    ...
    data-sectionid="sections"
    className="section-2665 intensive-page--2-0"
  >
    <div className="div-block-21067">
      ...
      <div>
        <div className="div-block-21072 div1290">
          <div className="div-block-21068 div-width">
            <div className="w-layout-grid grid-8644 intensive--20">
              <div
                id="w-node-_3c0fab3a-dc57-ab48-ea16-da47c19497c4-c19497ba"
                className="div-block-21070"
              >
                <div className="w-embed">
                  <img
              ...
              <div
                id="w-node-_3c0fab3a-dc57-ab48-ea16-da47c19497cb-c19497ba"
                className="div-block-21070"
              >
                <div className="w-embed">
                  <img
            ...
            <div>
              <div className="collection-list-wrapper-4 show w-dyn-list">
                <div role="list" className="w-dyn-items">
                  <div role="listitem" className="w-dyn-item">
                    <div className="date-changes-cms-collection-container-intensive left-aligin">
                      <div className="intensive-batch-details-div-copy">
                        <div className="start-batch-circle" />
                        <div className="int-batch-txt-copy">
                          Next batch starts tomorrow
                      ...
                      <div className="embed-btn w-embed">
                        <div className="dates-changing-ctas">
                          <a
                            id="enroll-now-trusted-by-thousands-desktop"
                            href="#pricing"
                            className="book-a-free-demo-main-btn track-class w-button"
                          >
                            Enroll Now
                          ...
                          <a
                            style={{ display: "block" }}
                            href="#hero-section"
                            id="book-a-free-demo-trusted-by-thousands-desktop"
                            className="book-a-free-demo-main-btn secondary-cta-btn highlight-btn track-class w-button"
                          >
                            Book a Free Demo
                          </a>
            ...
            <div className="logo-row-wrapper">
              <div className="logo-row-left-div">
                ...
                <div className="div-block-183198052117">
                  ...
                  <div className="div-block-183198052092">
                    <div className="text-block-911">
                      <strong>Izajur Rahaman</strong>
                    </div>
                    <div className="text-block-912">Secured Internship in</div>
                    <div className="w-embed">
                      <img
                        className="company-logo-testimonial"
              ...
              <div className="logo-row-right-div">
                ...
                <div className="div-block-183198052117">
                  ...
                  <div className="div-block-183198052092">
                    <div className="text-block-911">
                      <strong>Shailesh</strong>
                    </div>
                    <div className="text-block-912">Member Technical</div>
                    <div className="w-embed">
                      <img
                        className="company-logo-testimonial"
                        src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Reviews/company-logos/adp.png"
              ...
              <div className="logo-row-left-div">
                ...
                <div className="div-block-183198052117">
                  ...
                  <div className="div-block-183198052092">
                    <div className="text-block-911">
                      <strong>Surya Satya</strong>
                    </div>
                    <div className="text-block-912">Associate Engineer</div>
                    <div className="w-embed">
                      <img
                        className="company-logo-testimonial"
              ...
              <div className="logo-row-right-div">
                ...
                <div className="div-block-183198052117">
                  ...
                  <div className="div-block-183198052092">
                    ...
                    <div className="text-block-912">Associate consultant</div>
                    <div className="w-embed">
                      <img
                        className="company-logo-testimonial"
        ...
        <div>
          <div className="collection-list-wrapper-4 w-dyn-list">
            <div role="list" className="w-dyn-items">
              <div role="listitem" className="w-dyn-item">
                <div className="date-changes-cms-collection-container-intensive plr-16">
                  <div className="intensive-batch-details-div-copy">
                    <div className="start-batch-circle" />
                    <div className="int-batch-txt-copy">
                      Next batch starts tomorrow
                  ...
                  <div className="embed-btn w-embed">
                    <div className="dates-changing-ctas">
                      <a
                        id="enroll-now-trusted-by-thousands-mobile"
                        href="#pricing"
                        className="book-a-free-demo-main-btn track-class w-button"
                      >
                        Enroll Now
                      ...
                      <a
                        style={{ display: "block" }}
                        id="book-a-free-demo-trusted-by-thousands-mobile"
                        href="#hero-section"
                        className="book-a-free-demo-main-btn secondary-cta-btn highlight-btn track-class w-button"
                      >
                        Book a Free Demo
  ...
  <section id="hiring-companies-intensive" data-sectionid="sections">
    <div className="hiring-companies-scroll-section">
      <div>
        <div>
          <div className="div-block-1996">
            <div className="div-block-1557">
              <div className="div-block-867-copy-2 div234">
                <h2 className="heading-sathosi-font font-size-48 center">
                  1700+ Companies Hired NxtWave&nbsp;
                  <span className="text-span-1598">
                    <strong>R&nbsp;</strong>
                  </span>
                  Learners
                </h2>
                <div className="_1500-companies-underline w-embed">
                  <img
          ...
          <div className="div-block-1831980521408">
            <div className="html-embed-82636 w-embed">
              <style
                dangerouslySetInnerHTML={{
                  __html:
              ...
              <div className="marquee1">
                ...
                <div aria-hidden="true" className="marquee__group1">
                  <img
                    className="companies-img"
                    src="https://nxtwave.imgix.net/ccbp-website/nxtwave-intensive-2.0/company-scroll-strip-img-1.png"
                    loading="lazy"
            ...
            <div className="w-embed">
              ...
              <div className="marquee2">
                ...
                <div aria-hidden="true" className="marquee__group2">
                  <img
                    className="companies-img"
                    src="https://nxtwave.imgix.net/ccbp-website/nxtwave-intensive-2.0/company-scroll-strip-img-2.png"
                    loading="lazy"
          ...
          <div role="listitem" className="w-dyn-item">
            <div className="date-changes-cms-collection-container-intensive plr-16">
              ...
              <div className="dates-changing-ctas">
                <div className="embed-btn w-embed">
                  <a
                    id="enroll-now-hiring-companies"
                    href="#pricing"
                    className="book-a-free-demo-main-btn track-class w-button"
                  >
                    Enroll Now
                ...
                <a
                  id="view-all-companies-hiring-companies"
                  rel="nofollow"
  ...
  >
    <div className="why-top-compines-main-container">
      <div className="div-block-1831980521447253">
        <div className="div-block-1831980521447251">
          <div className="text-block-9412882471">
            Why{" "}
            <span className="blue-highlight-span-txt-copy">Top Companies</span>{" "}
            Prefer{" "}
            <span className="blue-highlight-span-txt-copy">
              NxtWave Students
            </span>
          </div>
        ...
        <div className="div-block-1831980521447252">
          <div
            id="companies-hired-videocompanies-experiences"
            style={{ paddingTop: "56.17021276595745%" }}
            className="w-embed-youtubevideo youtube-2 track-button"
          >
            <iframe
              src="https://www.youtube.com/embed/j6pkwZIXQzk?rel=0&controls=1&autoplay=0&mute=0&start=3"
              frameBorder={0}
              style={{
                position: "absolute",
                left: 0,
      ...
      <div
        data-delay={4000}
        data-animation="slide"
        className="why-top-compaines-sliders w-slider"
        data-autoplay="false"
        data-easing="ease"
        data-hide-arrows="false"
        data-disable-swipe="false"
        ...
        data-infinite="true"
      >
        <div className="top-compaines-mask w-slider-mask">
          <div className="top-compines-slide w-slide">
            <div
              id="kloudworkx-experience-videocompanies-experiences"
              style={{ paddingTop: "56.17021276595745%" }}
              className="w-embed-youtubevideo youtube-3 track-button"
            >
              <iframe
                ...
                allow="autoplay; encrypted-media"
                allowFullScreen=""
                title="NxtWave Hire: Transforming Hiring Experiences for Startups | NxtWave Placements 2023 | KloudWorx"
              />
            </div>
          </div>
          <div className="top-compines-slide w-slide">
            <div
              id="epsoft-experience-videocompanies-experiences"
              style={{ paddingTop: "56.17021276595745%" }}
              className="w-embed-youtubevideo youtube-3 track-button"
            >
              <iframe
                ...
                allow="autoplay; encrypted-media"
                allowFullScreen=""
                title="NxtWave Hire - We'll continue to hire from NxtWave | EP Soft | NxtWave Placements 2023"
              />
            </div>
          </div>
          <div className="top-compines-slide w-slide">
            <div
              id="shilpa-hr-experience-videocompanies-experiences"
              style={{ paddingTop: "56.17021276595745%" }}
              className="w-embed-youtubevideo youtube-3 track-button"
            >
              <iframe
                ...
                allow="autoplay; encrypted-media"
                allowFullScreen=""
                title="NxtWave Hire - One Stop Solution For Hiring Best Candidates | NxtWave Placements 2023"
              />
            </div>
          </div>
          <div className="top-compines-slide w-slide">
            <div
              id="rahul-cto-experience-videocompanies-experiences"
              style={{ paddingTop: "56.17021276595745%" }}
              className="w-embed-youtubevideo youtube-3 track-button"
            >
              <iframe
                ...
                allow="autoplay; encrypted-media"
                allowFullScreen=""
                title="NxtWave Hire - Candidates better than freshers straight from college | @NxtWaveTech"
              />
            </div>
          </div>
          <div className="top-compines-slide w-slide">
            <div
              id="mohammad-hr-experience-videocompanies-experiences"
              style={{ paddingTop: "56.17021276595745%" }}
              className="w-embed-youtubevideo youtube-3 track-button"
            >
              <iframe
                ...
                allow="autoplay; encrypted-media"
                allowFullScreen=""
                title="NxtWave Hire - A Reliable Resource for Hiring Developers | Caprus IT | NxtWave Placements 2023"
              />
            </div>
          </div>
        </div>
        <div
          id="left-arrow-companies-experiences"
          className="left-arrow-12382 track-button w-slider-arrow-left"
        >
          <div className="companies-left-arrow" />
          <div className="mobile-hide-arrows-copy w-embed">
            <img
        ...
        <div
          id="right-arrow-companies-experiences"
          className="right-arrow-2192 track-button w-slider-arrow-right"
        >
          <div className="companies-right-arrow" />
          <div className="mobile-hide-arrows-copy w-embed">
            <img
        ...
        <div className="nav-sllide w-slider-nav w-round" />
      </div>
      <div className="collection-list-wrapper-11 w-dyn-list">
        <div role="list" className="w-dyn-items">
          <div role="listitem" className="w-dyn-item">
            <div className="date-changes-cms-collection-container-intensive _100">
              <div className="intensive-batch-details-div-copy">
                <div className="start-batch-circle" />
                <div className="int-batch-txt-copy">
                  Next batch starts tomorrow
              ...
              <div className="embed-btn w-embed">
                <div className="dates-changing-ctas">
                  <a
                    id="enroll-now-companies-experiences"
                    href="#pricing"
                    className="book-a-free-demo-main-btn track-class w-button"
                  >
                    Enroll Now
                  ...
                  <a
                    style={{ display: "block" }}
                    id="book-a-free-demo-recognised-by"
                    href="#hero-section"
                    className="book-a-free-demo-main-btn secondary-cta-btn highlight-btn track-class w-button"
                  >
                    Book a Free Demo
  ...
  <section
    id="certificate"
    data-sectionid="sections"
    className="irc-certificate-section"
  >
    <div className="get-certified-div">
      <div className="div-block-1877">
        <div className="div-block-1880">
          <div className="div-block-1831980521433">
            <div className="heading-sathosi-font font-size-48">
              Get Certified
            </div>
            <div className="get-certified-under-line w-embed">
              <img
          ...
          <div className="div-block-1878">
            <div className="image-745 w-embed">
              <img
                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/intensive/certificate-mobile.svg"
                loading="lazy"
              />
            </div>
            <div className="irc-image w-embed">
              <img
                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/intensive/irc-image.svg"
                alt="irc"
                loading="lazy"
              />
            </div>
          ...
          <div className="div-block-1878">
            <div className="image-745 w-embed">
              <img
                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/intensive/sharable-mobile.svg"
                loading="lazy"
              />
            </div>
            <div className="shareable-image w-embed">
              <img
                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/intensive/sharabel-image.svg"
                alt=""
                loading="lazy"
              />
            </div>
            <div className="div-block-1879">
              ...
              <div className="text-block-837">
                Add it to your LinkedIn, share it on Twitter &amp; WhatsApp, or
                via Email. Make your profile stand out everywhere.
              </div>
            </div>
          </div>
          <div className="div-block-1878">
            <div className="image-745 w-embed">
              <img
                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/intensive/search-mobile.svg"
                loading="lazy"
              />
            </div>
            <div className="companies-search w-embed">
              <img
                src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/intensive/search-image.svg"
                alt=""
                loading="lazy"
              />
            </div>
          ...
          <div className="div-block-1881">
            <a
              ...
              className="button-101 w-button"
            >
              Reserve seat
            </a>
            <a
              href="#"
              id="see-pricing-hero-section"
              className="see-pricing-2 w-button"
            >
              See Pricing
            </a>
            <a
              id="Request-a-Call-Back-Hero-Section"
              href="https://forms.ccbp.in/public/form/talk-to-career-expert"
              className="requestcallback w-button"
            >
              Request Callback
            </a>
            <a
              id="Request-a-Call-Back-IRC-Certificate-section"
              href="https://forms.ccbp.in/public/form/talk-to-career-expert"
              className="reserve-seat-cta w-inline-block"
            >
              ...
              <div className="embed-btn w-embed">
                <div className="dates-changing-ctas">
                  ...
                  <a
                    style={{ display: "block" }}
                    href="#hero-section"
                    id="book-a-free-demo-get-certified"
                    className="book-a-free-demo-main-btn secondary-cta-btn highlight-btn track-class w-button"
                  >
                    Book a Free Demo
                  </a>
  ...
  >
    <div id="check--ins" className="why-join-intensive-container-div">
      <div className="why-int-content-container">
        <div className="why-int-heading-container">
          <div className="h2a">Why Join Intensive?</div>
        </div>
        <div className="why-int-comaprison-table">
          <div className="comparison-row-div">
            <div className="comparison-row-heading-div" />
            <div className="comparison-rows-container">
              <div className="comparison-odd-rows">
                <div>Curriculum</div>
              </div>
              <div className="comparison-even-rows">
                <div className="comparison-txt2">Doubts Clarification</div>
              </div>
              <div className="comparison-odd-rows trainers">
                <div>Trainers</div>
              </div>
              <div className="comparison-even-rows">
                <div className="comparison-txt2">Placements Record</div>
              </div>
              <div className="comparison-odd-rows">
                <div className="comparison-txt2">Placements Opportunities</div>
              </div>
              <div className="comparison-even-rows">
                <div className="comparison-txt2">Institute Recognised by</div>
              </div>
              <div className="comparison-odd-rows">
                <div>Projects</div>
              </div>
              <div className="comparison-even-rows">
                <div className="comparison-txt2">Access to Labs</div>
              </div>
              <div className="comparison-odd-rows">
                <div className="comparison-txt2">AI Mock Interviews</div>
              </div>
              <div className="comparison-even-rows">
                <div className="comparison-txt2">Expert Mock Interviews</div>
              </div>
              <div className="comparison-odd-rows">
              ...
              <div className="comparison-even-rows last-row-height">
                <div className="comparison-txt2">Scheduling Interviews</div>
              </div>
              <div className="comparison-odd-rows">
                <div className="comparison-txt2">
                  Salary Negotiation with <br />
                  Companies
                </div>
              </div>
            </div>
          ...
          <div className="comparison-column-div">
            <div className="comparison-int-col-container">
              <div className="comparison-col1-heading-2">Intensive 3.0</div>
              ...
              <div className="comparison-txt1">
                Alumni of IIT &amp; Top MNCs like Amazon, Microsoft. <br />
              ...
              <div className="comparison-txt1">
                Unlimited from a pool of <br />
                3000+ companies
              </div>
              <div className="comparison-content-div">
                <div className="comparison-txt">Recognized by</div>
                <div className="comparison-image-div">
                  <div className="w-embed">
                    <img
                      className="awards-section-imgs"
                      src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/nxtwave-intensive-2.0/pricing-section/pricing-section-nsdc.svg"
                      loading="lazy"
                    />
                    <style
                      dangerouslySetInnerHTML={{
                  ...
                  <div className="w-embed">
                    <img
                      className="awards-section-imgs"
                      src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/nxtwave-intensive-2.0/pricing-section/pricing-section-nasscom.svg"
                      loading="lazy"
                    />
                  </div>
                </div>
              ...
              <div className="comparison-txt1">
                24x7 Online State-of-the-art Labs. No&nbsp;installation/setup
                needed.
              </div>
              <div className="comparison-txt1">with NxtMock</div>
              <div className="comparison-txt1">
                with Dedicated Tech &amp; HR Panels
              </div>
              <div className="comparison-txt1">Access to 300+ Sessions</div>
              <div className="comparison-content-div">
                <div className="w-embed">
                  <img
                    className="close-and-tick-marks-icons1"
                    src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/nxtwave-intensive-2.0/tick-circle.png"
                    loading="lazy"
                  />
                </div>
              </div>
              <div className="comparison-content-div">
                ...
                <div className="comparison-txt">For higher salaries</div>
              </div>
            </div>
            <div className="comparison-other-col-container">
              <div className="comparison-col2-heading">
                Other Coaching Institutes
              </div>
              <div className="comparison-txt1">Not industry-aligned</div>
              <div className="comparison-txt1">Only 1-2 hours per day</div>
              <div className="comparison-txt1">
              ...
              <div className="comparison-txt1">Limited (15-20)</div>
              <div className="comparison-txt1">No recognition</div>
              <div className="comparison-txt1">~1-2 real time projects</div>
              <div className="comparison-txt1">Only 2 hours/day</div>
              <div className="comparison-content-div">
                <div className="w-embed">
                  <img
                    className="close-and-tick-marks-icons1"
                    src="https://nxtwave.imgix.net/ccbp-website/nxtwave-intensive-2.0/close-circle.png"
                  />
                  <style
                    dangerouslySetInnerHTML={{
                      __html:
              ...
              <div className="comparison-content-div">
                <div className="w-embed">
                  <img
                    className="close-and-tick-marks-icons1"
                    src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/nxtwave-intensive-2.0/close-circle.png"
                    loading="lazy"
                  />
                  <style
                    dangerouslySetInnerHTML={{
        ...
        <div className="div-block-1831980521387" />
      </div>
      <div className="w-dyn-list">
        <div role="list" className="w-dyn-items">
          <div role="listitem" className="w-dyn-item">
  ...
  <section id="awards" data-sectionid="sections" className="awarded-slider">
    <div className="awarded-slider-main-container">
      <div
        data-delay={4000}
        data-animation="slide"
        className="slider-awarded w-slider"
        data-autoplay="false"
        data-easing="ease"
        data-hide-arrows="false"
        data-disable-swipe="false"
        ...
        data-infinite="false"
      >
        <div className="awarded-mask w-slider-mask">
          <div className="each-slide w-slide">
            <div className="each-div-container">
              <div className="card-1">
                <div className="text-block-9412882473">
                  Founders{" "}
                  <span className="span-gold-color-bold">
                    Mr. Anupam Pedarla and Mr. Sashank Gujjula{" "}
                  </span>
                  made it to the{" "}
                  <span className="span-gold-color-bold">
                ...
                <div className="div-block-1831980521447257">
                  <div className="html-embed-82634 w-embed">
                    <img
          ...
          <div className="each-slide w-slide">
            <div className="each-div-container">
              <div className="eachcard-2">
                <div className="card-text">
                  Recognized as the Greatest Brand in Education
                </div>
                <div className="each-card-div">
                  <div className="edtech-award-div">
                    <div className="html-embed-82624 w-embed">
                      <img
                        src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Home/best-skill.png"
                        alt=""
                        loading="lazy"
                        className="awardImage"
                      />
                    </div>
                    <div className="div-block-1831980521447243-copy">
                      <div className="text-block-9412882465-copy">
                        Recognised as
                      </div>
                      <div className="text-block-9412882466-copy">
                        Best Tech Skilling
                        <br />
                        EdTech Company
                      </div>
                      <div className="text-block-9412882467-copy">
                        by Times Business Awards in 2022
                      </div>
                    </div>
                  </div>
                  <div className="div-block-1831980521447242-copy">
                    <div className="html-embed-82624-copy w-embed">
                      <img
                    ...
                    <div className="div-block-1831980521447243-copy-copy">
                      <div className="text-block-9412882465-copy">
                        Recognised as
                      </div>
                      <div className="text-block-9412882466-copy">
                  ...
                  <div className="div-block-1831980521447259">
                    <div className="html-embed-82632 w-embed">
                      <img
                        className="business-award"
                        src="https://nxtwave.imgix.net/ccbp-website/nxtwave-intensive-2.0/most-preffered-brands-award.png"
                        loading="lazy"
                      />
                    </div>
                  </div>
                  <div className="div-block-1831980521447256">
                    <div className="html-embed-82633 w-embed">
                      <img
                        className="business-award"
                        src="https://nxtwave.imgix.net/ccbp-website/nxtwave-intensive-2.0/indias-greatest-brands-award.png"
                        loading="lazy"
                      />
                    </div>
                  </div>
          ...
          <div className="each-slide w-slide">
            <div className="each-div-container">
              <div className="card-1">
                <p className="paragraph-695">
                  <span className="span-gold-color-bold">
                    Mr. Sashank Gujjula, Co-founder, NxtWave,{" "}
                  </span>
                  receiving the{" "}
                  <span className="span-gold-color-bold">
                    ‘Best Tech Skilling EdTech Company’ award
                  </span>{" "}
                  by Times Business Awards
                </p>
                <div className="div-block-1831980521447257-copy-2">
                  <div className="html-embed-82634-copy w-embed">
                    <img
                      src="https://nxtwave.imgix.net/ccbp-website/Home/award-by-time-business.png"
                      alt="award-by-time-business"
                      loading="lazy"
                    />
                  </div>
                </div>
          ...
          <div className="each-slide w-slide">
            <div className="each-div-container">
              <div className="card-1">
                <div className="text-block-9412882473">
                  <span className="span-gold-color-bold">
                    Mr. Sashank Gujjula, Co-founder,
                  </span>{" "}
                  NxtWave, receiving the{" "}
                  <span className="span-gold-color-bold">
                    prestigious award by T-Hub
                  </span>
                </div>
                <div className="div-block-1831980521447257-copy">
                  <div className="html-embed-82634-copy w-embed">
                    <img
          ...
          <div className="each-slide w-slide">
            <div className="each-div-container">
              <div className="card-1">
                <div className="recognised-text">Recognised by</div>
                <div className="card-bg-container">
                  <div className="div-block-1831980521447258">
                    <div>
                      <div className="w-embed">
                        <style
                          dangerouslySetInnerHTML={{
                        ...
                        <img
                          className="nasscom"
                          src="https://nxtwave.imgix.net/ccbp-website/nxtwave-intensive-2.0/awards-section/awards-section-nasscom-mobile.svg"
                          loading="lazy"
                        />
                      </div>
                    </div>
                    <div>
                      <div className="w-embed">
                        ...
                        />
                        <img
                          className="nsdc-india"
                          src="https://nxtwave.imgix.net/ccbp-website/nxtwave-intensive-2.0/awards-section/awards-section-nsdc-mobile.svg"
                          loading="lazy"
                        />
                      </div>
                    </div>
                    <div>
                      <div className="w-embed">
                        ...
                        />
                        <img
                          className="startup-india"
                          src="https://nxtwave.imgix.net/ccbp-website/nxtwave-intensive-2.0/awards-section/awards-section-startup-india-mobile-mobile-mobile.svg"
                          loading="lazy"
                        />
                      </div>
                    </div>
                  ...
                  <div>
                    <div className="w-embed">
                      ...
                      />
                      <img
                        className="ministry-india"
                        src="https://nxtwave.imgix.net/ccbp-website/nxtwave-intensive-2.0/awards-section/awards-section-ministry-of-india-mobile.png"
                        loading="lazy"
                      />
                    </div>
                  </div>
        ...
        <div
          id="left-arrow-recognised-by"
          className="recogined-left-arrow track-button w-slider-arrow-left"
        >
          <div className="recogined-companies-left-arrow" />
        </div>
        <div
          id="right-arrow-recognised-by"
          className="recogined-right-arrow track-button w-slider-arrow-right"
        >
          <div className="recogined-companies-right-arrow" />
        </div>
        <div className="slide-nav-dots w-slider-nav" />
      </div>
      <div className="w-embed">
        <style
          dangerouslySetInnerHTML={{
  ...
  <div
    id="pricing"
    data-sectionid="sections"
    className="div-block-1831980521417"
  >
...
https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/nxtwave-intensive-2.0/pricing-section/pricing-section-hours.svg"
                ...
                <div>
                  <div className="div-block-1831980521391-copy">
                    ...
                    <div className="div-block-183198052143938">
                      ...
                      >
                        <div className="ribbion-container-2">
                          <div className="apply-scholorship-text-2">
                            Additional Scholarships Up To
                          </div>
                          <div className="ribbon-glow">
                            <div className="ribbion-glow-2" />
                            <div className="ribbion-glow-1" />
                          </div>
                          <img
                            loading="lazy"
                            src="https://assets-global.website-files.com/6413e0030367922facca6873/641bfef222ca746d6bd6ece3_Slice%201.png"
                            alt=""
                            className="image-812882290"
                          />
                        </div>
                        <div className="scholarship-pricing-container">
                          <div className="pricing-text-2">₹16,000/-</div>
                          <div className="w-embed">
                            <a
                              id="book-a-free-demo-to-know-more-postpaid-tab-pricing-mobile"
                              href="#hero-section"
                              className="book-a-free-demo-container track-class w-inline-block"
                            >
                              <div className="request-acall-back-link">
                                Book a Free Demo to know more.
                              </div>
                              <div className="anchor-svg w-embed">
                                <img
                                  height={11}
                                  width={11}
                                  src="https://assets-global.website-files.com/6413e0030367922facca6873/641bf0016de2d684c62d7109_Icon.svg"
                                />
                              </div>
                            </a>
                          </div>
                        </div>
                        <div className="pricing-logo w-embed">
                          <style
                            dangerouslySetInnerHTML={{
                              __html:
                          ...
                          />
                          <img
                            className="money-image-styles"
                            src="https://nxtwave.imgix.net/ccbp-website/nxtwave-intensive-2.0/money-image.png"
                          />
                        </div>
                      </div>
                    </div>
                  ...
                  <div role="listitem" className="w-dyn-item">
                    <div className="date-changes-cms-collection-container left-aligin">
                      ...
                      <div className="dates-changing-ctas">
                        <div className="embed-btn w-embed">
                          <a
                            href="https://accounts.ccbp.in/register/ccbp-tech-intensive-postpaid"
                            target="_blank"
                            id="enroll-now-postpaid-tab-pricing"
                            className="book-a-free-demo-main-btn track-class w-button"
                          >
                            Enroll Now
                          </a>
                        ...
                        <a
                          id="reserve-a-seat-for-postpaid-tab-pricing"
                          href="https://accounts.ccbp.in/register/intensive-book-your-seat"
                          target="_blank"
                          className="reserve-seat-postpaid-button track-class w-button"
                        >
            ...
            <div data-w-tab="Tab 2" className="w-tab-pane">
              <div className="pricing-prepaid-tab-content">
                ...
                <div className="prepaid-features-container">
                  <div className="prepaid-txt1">Everything in Postpaid</div>
                  <div className="prepaid-txt2">+</div>
                  <div className="prepaid-txt3">
                    After you complete the course, if you don't get a job, the
                    amount paid will be refunded with a deduction (
                    <a
                      href="https://www.ccbp.in/terms-and-conditions#Intensive-Terms"
                      target="_blank"
                ...
                <div className="prepaid-pricing-details-div">
                  ...
                  <div className="program-price">₹90,000/-</div>
                </div>
              </div>
              <div className="pre-paid-collection w-dyn-list">
                <div role="list" className="w-dyn-items">
                  <div role="listitem" className="w-dyn-item">
                    <div className="date-changes-cms-collection-container left-aligin">
                      <div className="intensive-batch-details-div-copy">
                      ...
                      <div className="dates-changing-ctas">
                        <div className="embed-btn w-embed">
                          <a
                            href="https://accounts.ccbp.in/register/ccbp-tech-intensive-prepaid"
                            id="enroll-now-prepaid-tab-pricing"
                            target="_blank"
                            className="book-a-free-demo-main-btn track-class w-button"
                          >
                            Enroll Now
                        ...
                        <a
                          id="reserve-a-seat-for-prepaid-tab-pricing"
                          href="https://accounts.ccbp.in/register/intensive-book-your-seat"
                          target="_blank"
                          className="reserve-seat-postpaid-button track-class w-button"
                        >
              ...
              <div className="question-answers-container">
                  ...
                  <div className="faq-ans">
                    <div className="faq-anws-container">
                      <p className="faq-ans-p">
                        Completing the fundamentals classes would usually take 2
                        months.
                      </p>
                      <p className="faq-ans-p">
                        After that, the duration would depend on the job track
                        you choose. While you learn in a job track, you’ll build
                        multiple real-world projects to build a digital
                        portfolio that makes your profile super strong and
                        attracts better salaries.
                      </p>
                      <p className="faq-ans-p">
                        You’ll receive dedicated placement support for 16 months
                        from the date of joining. During this period, you’ll
                        prepare a strong resume with expert guidance and undergo
                        mock interviews with your Tech and HR panels. This makes
                        you ready to face the real interviews with confidence.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="faq-qaa-main-conatainer">
                  ...
                  <div className="faq-ans">
                    <div className="faq-anws-container">
                      <p className="faq-ans-p">
                        NxtWave Intensive Curriculum is proven to build
                        industry-relevant skills. You can get ready for multiple
                        IT career paths. You’ll start by learning fundamentals.
                        After learning fundamentals, you can choose a job track.
                        <br />
                      </p>
                      <div className="faq-ans-p">Jobs Tracks Offered:</div>
                      <ul role="list" className="list-container">
                        <li className="list-item-14662">
                          <div>MERN Full Stack</div>
                        </li>
                        <li className="list-item-14662">
                        ...
                        <li className="list-item-14662">
                          <div>QA / Automation Testing</div>
                        </li>
                      </ul>
                      <p className="faq-ans-p">
                        You’ll also receive recommendation for a job track that
                        is suitable for you based on your score in the
                        fundamentals&nbsp;exam. Why is the NxtWave Intensive
                        curriculum so successful?&nbsp;
                      </p>
                      <ul role="list" className="list-container">
                        <li className="list-item-text">
                          The curriculum is designed by developers who built
                          world-class products and worked at top technology
                          companies like Amazon, Microsoft, etc. So it is
                          industry aligned.
                        </li>
                        <li className="list-item-text">
                          You’ll learn by building real-world projects. For
                          example, you'll learn by developing a web application
                          like Zomato, Twitter etc. All these projects become
                          your portfolio that you can showcase to anyone,
                          anywhere.{" "}
                        </li>
                        <li className="list-item-text">
                          The curriculum is highly structured. You’ll learn
                          everything in the perfect sequence. Also, the
                          assessments, coding practices and mock tests help you
                          build much-needed problem-solving and application
                          skills.
                        </li>
                      </ul>
                    </div>
                ...
                <div className="faq-qaa-main-conatainer">
                  ...
                  >
                    <h4 className="faq-q-h">
                      Why is everyone saying NxtWave online sessions are
                      extremely effective?
                  ...
                  <div className="faq-ans">
                    <div className="faq-anws-container">
                      <p className="faq-ans-p">
                        Well, on NxtWave platform, it’s not just online
                        sessions. But it’s a comprehensive online learning
                        ecosystem.
                      </p>
                      <p className="faq-ans-p">
                        The platform is carefully designed to take care of all
                        your learning needs. For example, 24x7 Online Labs allow
                        you to practice instantly while you attend a session.
                        And it’s natural to get doubts while you learn something
                        new. But you’ll never get stuck up with them as you can
                        reach out to domain experts without any hassles through
                        discussion forums on the platform.&nbsp;
                        <br />
                      </p>
                      <p className="faq-ans-p">
                        By revising sessions anytime, you can learn in your own
                        time and at your own pace. And you need not prepare
                        summary notes for sessions because the summary
                        notes/cheat sheets on the platform do that job for you
                        with all the key concepts of a topic in one place.By
                        revising sessions anytime, you can learn in your own
                        time and at your own pace. And you need not prepare
                        summary notes for sessions because the summary
                        notes/cheat sheets on the platform do that job for you
                        with all the key concepts of a topic in one place.
                        <br />
                      </p>
                      <p className="faq-ans-p">
                        Most importantly, you’ll always stay motivated to learn
                        because you can track your daily progress. And social
                        learning with batchmates keeps you engaged.
                      </p>
                      <p className="faq-ans-p">
                        Read many learners sharing their love and experience of
                        learning online at NxtWave:{" "}
                        <a
                          href="https://www.ccbp.in/reviews"
                          className="link-89"
                        >
                  ...
                  <div className="faq-ans">
                    <div className="faq-anws-container">
                      <p className="faq-ans-p">
                        ...
                        webinars happen, you need to attend them at a particular
                        time. Mostly such webinars happen during weekends or in
                        the evenings of working days. All the learning modules
                ...
                <div className="faq-qaa-main-conatainer">
                  ...
                  <div className="faq-ans">
                    <div className="faq-anws-container">
                      <p className="faq-ans-p">
                        Yes, it’s natural to get doubts while you learn
                        something new. But you’ll never get stuck up with them
                        as you can reach out to domain experts from 9 AM - 9 PM
                        every day. Doubts clarification at NxtWave is 7x faster
                        than the industry standards.
                      </p>
                      <p className="faq-ans-p">
                        You can post your questions in the discussions forum and
                        domain experts will get back to you with
                        solutions/clarifications. You can also see the questions
                        and answers posted by other students and get a better
                ...
                <div className="faq-qaa-main-conatainer">
                  ...
                  <div className="faq-ans">
                    <div className="faq-anws-container">
                      <p className="faq-ans-p">
                        In any skill, when you're strong with the fundamentals,
                        you learn quickly and master it faster. And software
                        development is no exception. If you build solid
                        foundations, you can learn advanced concepts, languages
                        and frameworks easily.
                      </p>
                      <p className="faq-ans-p">
                        So we recommend that you learn right from fundamentals
                        at NxtWave Intensive even though you have undergone
                        training at another learning program. It is because you
                        learn programming in a non-conventional way here that
                        helps you develop the thinking patterns of a world-class
                        developer.
                        <br />
                      </p>
                    </div>
            ...
            <div data-w-tab="Tab 2" className="w-tab-pane">
              <div className="question-answers-container">
                  ...
                  <div className="faq-ans">
                    <div className="faq-anws-container">
                      <p className="faq-ans-p">
                        ...
                        ready for a tech job within a short time. Your degree,
                        branch, marks, or backlogs — nothing is a barrier to
                        join the program and get a tech job. You need not have
                        any previous coding knowledge. You’ll learn everything
                        from scratch.
                      </p>
                      <p className="faq-ans-p">
                        You may be afraid of coding due to your previous
                        experiences. But our passionate trainers will simplify
                        every concept and teach by integrating science-backed
                        methods. So you'll understand concepts easily, and they
                        stick in your mind instantly. It’s one of the reasons
                        why many of your friends are recommending that you join
                        NxtWave
                      </p>
                      <p className="faq-ans-p">
                        Within 2-3 weeks at NxtWave, you’ll become amazingly
                        confident about skills and fall in love with software
                        development. By the time you complete the program,
                        you’ll reach a stage where companies compete for you.
                      </p>
                      <p className="faq-ans-p">
                      ...
                      <p className="faq-ans-p">
                        Hundreds of NxtWave learners have proved that nothing
                        matters to get a tech job except your willingness to
                        learn. Read their inspiring success stories here:{" "}
                        <a
                          href="https://www.ccbp.in/reviews"
                          className="link-89"
                        >
                      ...
                      <p className="faq-ans-p">
                        The program is most suitable for final year students,
                        job seekers, and those looking to switch to a tech
                        career.
                      </p>
                    </div>
                  </div>
                ...
                <div className="faq-qaa-main-conatainer">
                  ...
                  >
                    <h4 className="faq-q-h">
                      How are many graduates with B.A, B.Com, BSc, MBA degrees
                      getting tech jobs?{" "}
                      <strong className="bold-text-132">
                        <br />
                      </strong>
                  ...
                  <div className="faq-ans">
                    <div className="faq-anws-container">
                      <p className="faq-ans-p">
                        ...
                        skills. As you’ll build many real-world projects during
                        the program, your resume will become very powerful. And
                        many NxtWave learners have proved it by getting placed
                        on par with those who hold a Computer Science degree.
                      </p>
                      <p className="faq-ans-p">
                        For example, Sonali, a NxtWave Intensive learner who has
                        a specialization in Chemistry got a tech job with ₹7
                        Lakhs annual salary at ADF, a US-based tech company.
                      </p>
                      <p className="faq-ans-p">
                ...
                <div className="faq-qaa-main-conatainer">
                  ...
                  >
                    <h4 className="faq-q-h">
                      Even with a career gap, how are many graduates getting a
                      tech job?
                      <strong className="bold-text-132">
                        <br />
                      </strong>
                  ...
                  <div className="faq-ans">
                    <div className="faq-anws-container">
                      <p className="faq-ans-p">
                        Your career gap is not a barrier to getting a tech job.
                        It’s because companies need candidates with practical
                        skills. As you’ll build many real-world projects during
                        the program, you’ll develop skills that companies look
                        for. Similarly, there are many such successful career
                        transformation stories of graduates with gaps in their
                        resumes. You can read their reviews and success stories
                        here:{" "}
                        <a
                          href="https://www.ccbp.in/reviews"
                          className="link-89"
                      ...
                      <p className="faq-ans-p">
                        ...
                        companies that are not concerned with your career gap.
                        Though opportunities for candidates with career gaps are
                        relatively lesser than recent graduates, there are many
                        opportunities even then.
                      </p>
                      <p className="faq-ans-p">
                        For example, Umamaheswari, a NxtWave Intensive learner
                        graduated in 2015. Later, she got married and couldn't
                        pursue a career as she took care of her family. She lost
                        nearly 7 years. Now, Uma got placed as a Business
                        Analyst at EXL Service.
                      </p>
                      <p className="faq-ans-p">
                        You can read her journey here:{" "}
                        <a
                          href="https://www.linkedin.com/posts/uma-maheswari-v-_firstjob-success-professionalwomen-activity-6905457142984249344-ftqJ/"
                          target="_blank"
                          rel="nofollow"
                          className="link-89"
                        >
                          https://www.linkedin.com/posts/uma-maheswari-v-_firstjob-success-professionalwomen-activity-6905457142984249344-ftqJ/
                        </a>
                      </p>
                      <p className="faq-ans-p">
                        Similarly, there are many such successful career
                  ...
                  <div className="faq-ans">
                    <div className="faq-anws-container">
                      <p className="faq-ans-p">
                        ...
                        because companies look for candidates with practical
                        skills. As you’ll build many real-world projects during
                        the program, your resume will become so powerful that
                        your branch will become insignificant before your
                        skills. And many NxtWave learners have proved it by
                        getting placed on par with Computer Science students.
                        <br />
                      </p>
                      <p className="faq-ans-p">
                        For example, Sushanth is a civil engineering graduate.
                        After building programming skills from scratch at
                        NxtWave, he cleared his first-ever tech interview in the
                        first attempt itself. Now, he got placed as a Full Stack
                        Developer at needl.ai with ₹11 lakhs per annum salary.
                      </p>
                      <p className="faq-ans-p">
                        Similarly, hundreds of non-CS graduates got tech jobs
                        with NxtWave Intensive. You can read their reviews and
                ...
                <div className="faq-qaa-main-conatainer last-child">
                  ...
                  <div className="faq-ans">
                    <div className="faq-anws-container">
                      <p className="faq-ans-p">
                        Yes, you need a laptop to learn effectively. While you
                        can attend sessions, participate in quizzes on your
                        mobile, you will need a laptop to work on coding
              ...
              <div className="question-answers-container">
                <div className="faq-qaa-main-conatainer">
                  ...
                  <div className="faq-ans">
                    <div className="faq-anws-container">
                      <p className="faq-ans-p">
                        After you complete the job track you have chosen in the
                        program, you’ll get Dedicated Placement Assistance with
                        Aptitude Training, Communication Skills Training, Resume
                        Preparation Support, Mock Interviews and more.
                        <br />
                      </p>
                      <p className="faq-ans-p">
                        Then, you can sit for placements with companies that are
                        hiring with NxtWave.{" "}
                        <strong>
                          During this period, interviews will be arranged until
                          you get a job. There is no limitation on the number of
                          interviews you can attend.&nbsp;
                        </strong>
                        <br />
                      </p>
                      <p className="faq-ans-p">
                        <strong>
                          You’ll receive dedicated placement support for 16
                          months from the date of joining. <br />
                          Please Note that NxtWave Intensive is NOT a Job
                          Guarantee Program.
                        </strong>
                        <br />
                      </p>
                      <p className="faq-ans-p">
                        You can check out the success stories of students who
                        placed through NxtWave here:
                        <a
                          href="https://www.ccbp.in/reviews"
                          className="link-89"
                        >
                  ...
                  <div className="faq-ans">
                    <div className="faq-anws-container">
                      <p className="faq-ans-p">
                        ...
                        recommend you to MNCs and startups in our network. You
                        need to accept the job offer if you clear the selection
                        process.
                        <br />
                      </p>
                    </div>
              ...
              <div className="question-answers-container">
                <div className="faq-qaa-main-conatainer">
                  ...
                  <div className="faq-ans">
                    <div className="faq-anws-container">
                      <p className="faq-ans-p">
                        IRC stands for Industry Ready Certification. Unlike any
                        other study certificate, IRC represents your readiness
                        for a job and approves that you have skills that
                        companies look for.
                        <br />
                      </p>
                      <p className="faq-ans-p">
                        NxtWave is one of the very few EdTech companies that is
                  ...
                  <div className="faq-ans">
                    <div className="faq-anws-container">
                      <p className="faq-ans-p">
                        ...
                        completing industry-aligned projects, assignments and
                        tests designed by world-class developers in the NxtWave
                        curriculum.
                        <br />
                      </p>
                      <p className="faq-ans-p">
                      ...
                      <p className="faq-ans-p">
                        ...
                        training programs that are proven to bring results after
                        an extensive evaluation process. So if you hold a
                        certificate recognized by NSDC, companies have greater
                        trust in your skills. It gives you an edge during
                        interviews.
                        <br />
                      </p>
                    </div>
              ...
              <div className="question-answers-container">
                <div className="faq-qaa-main-conatainer">
                  ...
                  <div className="faq-ans">
                    <div className="faq-anws-container">
                      <p className="faq-ans-p">
                        Yes, EMI support is available for credit cards. Please
                        select the EMI option while making payment for more
                        information.
                        <br />
                      </p>
                    </div>
  ...
  >
    <div className="learner-review-main-container">
      <h2 className="learner-heading">Hear NxtWave learners' experiences</h2>
      <div
        data-delay={3000}
        data-animation="slide"
        className="learner-expriences-slider w-slider"
        data-autoplay="false"
        data-easing="ease"
        data-hide-arrows="false"
        data-disable-swipe="false"
        ...
        data-infinite="true"
      >
        <div className="learner-mask w-slider-mask">
          <div className="slide-53-new w-slide">
            <a
              href="#"
              id="harshavardhan-pentakota-learners-experience"
              className="lightbox track-button w-inline-block w-lightbox"
            >
              <div className="videos-testimonials-card-copy">
                <div className="html-embed-19-new w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/harshavardhan-hentakotas .png"
                    alt="test image"
                    width="100%"
                    loading="lazy"
                  />
                </div>
                <div className="videos-content-div-new-copy">
                  <div className="text-block-9412882469">
                    From failing to crack govt. jobs to a tech career
                  </div>
                </div>
              </div>
            </a>
          ...
          <div className="slide-53-new w-slide">
            <a
              href="#"
              id="dhanusha-learners-experience"
              className="lightbox track-button w-inline-block w-lightbox"
            >
              <div className="videos-testimonials-card-copy">
                <div className="html-embed-19-new w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/dhanusha.png"
                    alt="test image"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="videos-content-div-new-copy">
                  <div className="text-block-627-copy">
                    From sales job to IT career
                  </div>
                </div>
              </div>
            </a>
          ...
          <div className="slide-53-new w-slide">
            <a
              href="#"
              id="shivaprasad-learners-experience"
              className="lightbox track-button w-inline-block w-lightbox"
            >
              <div className="videos-testimonials-card-copy">
                <div className="html-embed-19-new w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/shivaprasad.png"
                    alt="test image"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="videos-content-div-new-copy">
                  <div className="text-block-627-copy">
                    When Mechanical graduate turned tech employee
                  </div>
                </div>
              </div>
            </a>
          ...
          <div className="slide-53-new w-slide">
            <a
              href="#"
              id="34-students-at-uk-bank-learner-experience"
              className="lightbox track-button w-inline-block w-lightbox"
            >
              <div className="videos-testimonials-card-copy">
                <div className="html-embed-19-new w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/34-students-join-uk-bank.png"
                    alt="test image"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="videos-content-div-new-copy">
                  <div className="text-block-627-copy">
                    34 NxtWave students join UK's Top Retail Bank
                  </div>
                </div>
              </div>
            </a>
          ...
          <div className="slide-53-new w-slide">
            <a
              href="#"
              id="akash-nitish-learners-experience"
              className="lightbox track-button w-inline-block w-lightbox"
            >
              <div className="videos-testimonials-card-copy">
                <div className="html-embed-19-new w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/akash-nitish.png"
                    alt="test image"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="videos-content-div-new-copy">
                  <div className="text-block-627-copy">
                    From Civil Engineering to software career
                  </div>
                </div>
              </div>
            </a>
          ...
          <div className="slide-53-new w-slide">
            <a
              href="#"
              id="shaik-yahatash-learners-experience"
              className="light-box track-button w-inline-block w-lightbox"
            >
              <div>
                <div className="html-embed-19-new w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/shaik-yahatash.png"
                    alt="test image"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="videos-content-div-new-copy">
                  <div className="text-block-627-copy">
                    Beating the recession and getting an IT job
                  </div>
                </div>
              </div>
            </a>
          ...
          <div className="slide-53-new w-slide">
            <a
              href="#"
              id="mahesh-learners-experience"
              className="lightbox track-button w-inline-block w-lightbox"
            >
              <div className="videos-testimonials-card-copy">
                <div className="html-embed-19-new w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/mahesh.png"
                    alt="test image"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="videos-content-div-new-copy">
                  <div className="text-block-627-copy">
                    EEE grad became an IT professional
                  </div>
                </div>
              </div>
            </a>
          ...
          <div className="slide-53-new w-slide">
            <a
              href="#"
              id="nagabhushan-learners-experience"
              className="lightbox track-button w-inline-block w-lightbox"
            >
              <div className="videos-testimonials-card-copy">
                <div className="html-embed-19-new w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/nagabhushan.png"
                    alt="test image"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="videos-content-div-new-copy">
                  <div className="text-block-627-copy">
                    Tech win of a Chemistry graduate
                  </div>
                </div>
              </div>
            </a>
          ...
          <div className="slide-53-new w-slide">
            <a
              href="#"
              id="pradeep-learners-experience"
              className="lightbox track-button w-inline-block w-lightbox"
            >
              <div className="videos-testimonials-card-copy">
                <div className="html-embed-19-new w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/pradeep.png"
                    alt="test image"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="videos-content-div-new-copy">
                  <div className="text-block-627-copy">
                    Degree background to software career
                  </div>
                </div>
              </div>
            </a>
          ...
          <div className="slide-53-new w-slide">
            <a
              href="#"
              id="balraj-learners-experience"
              className="lightbox track-button w-inline-block w-lightbox"
            >
              <div className="videos-testimonials-card-copy">
                <div className="html-embed-19-new w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/balaraj-thupakula.png"
                    alt="test image"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="videos-content-div-new-copy">
                  <div className="text-block-627-copy">
                    ECE graduate to software engineer
                  </div>
                </div>
              </div>
            </a>
          ...
          <div className="slide-53-new w-slide">
            <a
              href="#"
              id="chintapalli-jyothi-amruth-sai-varun-learners-experience"
              className="lightbox track-button w-inline-block w-lightbox"
            >
              <div className="videos-testimonials-card-copy">
                <div className="html-embed-19-new w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/amruth-chintapalli.png"
                    alt="test image"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="videos-content-div-new-copy">
                  <div className="text-block-627-copy">
                    Political Science grad to a tech pro
                  </div>
                </div>
              </div>
            </a>
          ...
          <div className="slide-53-new w-slide">
            <a
              href="#"
              id="buchupalli-madan-mohan-reddy-learners-experience"
              className="lightbox track-button w-inline-block w-lightbox"
            >
              <div className="videos-testimonials-card-copy">
                <div className="html-embed-19-new w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/madhan-mohan.png"
                    alt="test image"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="videos-content-div-new-copy">
                  <div className="text-block-627-copy">
                    Mech graduate switched career from service advisor to
                    software engineer
                  </div>
                </div>
              </div>
          ...
          <div className="slide-53-new w-slide">
            <a
              href="#"
              id="vedavalli-learners-experience"
              className="lightbox track-button w-inline-block w-lightbox"
            >
              <div className="videos-testimonials-card-copy">
                <div className="html-embed-19-new w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/vedavalli.png"
                    alt="test image"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="videos-content-div-new-copy">
                  <div className="text-block-627-copy">
                    From B.Com to Software Success
                  </div>
                </div>
              </div>
            </a>
          ...
          <div className="slide-53-new w-slide">
            <a
              href="#"
              id="chandra-sekhar-kallipalli-learners-experience"
              className="lightbox track-button w-inline-block w-lightbox"
            >
              <div className="videos-testimonials-card-copy">
                <div className="html-embed-19-new w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/chandra-sekhar.png"
                    alt="test image"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="videos-content-div-new-copy">
                  <div className="text-block-627-copy">
                    From job dissatisfaction to a fulfilling career
                  </div>
                </div>
              </div>
            </a>
          ...
          <div className="slide-53-new w-slide">
            <a
              href="#"
              id="raveendra-gulivindala-learners-experience"
              className="lightbox track-button w-inline-block w-lightbox"
            >
              <div className="videos-testimonials-card-copy">
                <div className="html-embed-19-new w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/raveendra.png"
                    alt="test image"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="videos-content-div-new-copy">
                  <div className="text-block-627-copy">
                    Site Engineer transitioned to software engineer
                  </div>
                </div>
              </div>
            </a>
          ...
          <div className="slide-53-new w-slide">
            <a
              href="#"
              id="geetanjali-baliji-learners-experience"
              className="lightbox track-button w-inline-block w-lightbox"
            >
              <div className="videos-testimonials-card-copy">
                <div className="html-embed-19-new w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/geethanjali.png"
                    alt="test image"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="videos-content-div-new-copy">
                  <div className="text-block-627-copy">
                    Transition from Administration role to Java Developer
                  </div>
                </div>
              </div>
            </a>
          ...
          <div className="slide-53-new w-slide">
            <a
              href="#"
              id="sravanthi-journey-to-new-delhi-learners-experience"
              className="lightbox track-button w-inline-block w-lightbox"
            >
              <div className="videos-testimonials-card-copy">
                <div className="html-embed-19-new w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/national-recognition.png"
                    alt="test image"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="videos-content-div-new-copy">
                  <div className="text-block-627-copy">
                    4 year career gap to acheiving dream software job
                  </div>
                </div>
              </div>
            </a>
          ...
          <div className="slide-53-new w-slide">
            <a
              href="#"
              id="mahesh-khatal-learners-experience"
              className="lightbox track-button w-inline-block w-lightbox"
            >
              <div className="videos-testimonials-card-copy">
                <div className="html-embed-19-new w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/mahesh-khatal.png"
                    alt="test image"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="videos-content-div-new-copy">
                  <div className="text-block-627-copy">
                    2012 graduate cracked software job in 2023
                  </div>
                </div>
              </div>
            </a>
          ...
          <div className="slide-53-new w-slide">
            <a
              href="#"
              id="mohammed-saleem-learners-experience"
              className="lightbox track-button w-inline-block w-lightbox"
            >
              <div className="videos-testimonials-card-copy">
                <div className="html-embed-19-new w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/mohammed-saleem.png"
                    alt="test image"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="videos-content-div-new-copy">
                  <div className="text-block-627-copy">
                    From teaching career to tech career
                  </div>
                </div>
              </div>
            </a>
          ...
          <div className="slide-53-new w-slide">
            <a
              href="#"
              id="srivali-learners-experience"
              className="lightbox track-button w-inline-block w-lightbox"
            >
              <div className="videos-testimonials-card-copy">
                <div className="html-embed-19-new w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/srivalli.png"
                    alt="test image"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="videos-content-div-new-copy">
                  <div className="text-block-627-copy">
                    From Agriculture grad to IT professional
                  </div>
                </div>
              </div>
            </a>
          ...
          <div className="slide-53-new w-slide">
            <a
              href="#"
              id="mangaraju-learners-experience"
              className="lightbox track-button w-inline-block w-lightbox"
            >
              <div className="videos-testimonials-card-copy">
                <div className="html-embed-19-new w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/mangaraju.png"
                    alt="test image"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="videos-content-div-new-copy">
                  <div className="text-block-627-copy">
                    Delivery boy to a high-paying IT job
                  </div>
                </div>
              </div>
            </a>
          ...
          <div className="slide-53-new w-slide">
            <a
              href="#"
              id="raj-kumar-learners-experience"
              className="lightbox track-button w-inline-block w-lightbox"
            >
              <div className="videos-testimonials-card-copy">
                <div className="html-embed-19-new w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/raj-kumar.png"
                    alt="test image"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="videos-content-div-new-copy">
                  <div className="text-block-627-copy">
                    From a BPO job to skilled tech professional
                  </div>
                </div>
              </div>
            </a>
          ...
          <div className="slide-53-new w-slide">
            <a
              href="#"
              id="kiranmai-kasa-learners-experience"
              className="lightbox track-button w-inline-block w-lightbox"
            >
              <div className="videos-testimonials-card-copy">
                <div className="html-embed-19-new w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/kasa-kiranmai.png"
                    alt="test image"
                    width="100%"
                    loading="lazy"
                  />
          ...
          <div className="slide-53-new w-slide">
            <a
              href="#"
              id="sai-learners-experience"
              className="lightbox track-button w-inline-block w-lightbox"
            >
              <div className="videos-testimonials-card-copy">
                <div className="html-embed-19-new w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/srimannarayana-varma.png"
                    alt="test image"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="videos-content-div-new-copy">
                  <div className="text-block-627-copy">
                    2018 Mech grad cracked software job
                  </div>
                </div>
              </div>
            </a>
          ...
          <div className="slide-53-new w-slide">
            <a
              href="#"
              id="mani-ratna-learners-experience"
              className="lightbox track-button w-inline-block w-lightbox"
            >
              <div className="videos-testimonials-card-copy">
                <div className="html-embed-19-new w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/mani-ratna-gupta.png"
                    alt="test image"
                    width="100%"
                    loading="lazy"
                  />
        ...
        <div
          id="left-arrow-learners-experience"
          className="left-arrow-12383 track-button w-slider-arrow-left"
        >
          <div
            id="left-arrow-learner-experience"
            className="slider-video-left-arrow-new"
          />
          <div className="mobile-hide-arrows-copy-copy w-embed">
            <img
              src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/intensive/roundarrow.svg"
              loading="lazy"
            />
        ...
        <div
          id="right-arrow-learners-experience"
          className="right-arrow-2193 track-button w-slider-arrow-right"
        >
          <div className="slider-video-right-arrow-new" />
          <div className="mobile-hide-arrows-copy-copy w-embed">
            <img
              src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/intensive/roundbutton.svg"
              loading="lazy"
    ...
    <div className="media-main-container">
      ...
      <div className="slider-container">
        <div
          data-delay={6000}
          data-animation="slide"
          className="nxtwave-media-slider w-slider"
          data-autoplay="false"
          data-easing="ease"
          data-hide-arrows="false"
          data-disable-swipe="false"
          ...
          data-infinite="true"
        >
          <div className="media-mask w-slider-mask">
            <div className="mask-slide w-slide">
              <div className="each-card-container">
                <div className="date-compaine-container">
                  <div className="w-embed">
                    <img
                      src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Home/forbes-30-logo.png"
                  ...
                  <div className="date">26 Feb 2024</div>
                </div>
                <div className="w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/forbes-30-article.png"
                    alt="video-testimonials"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <a
                  id="forbes-30-under-30nxtwave-in-media"
                  rel="nofollow"
                  href="https://www.forbesindia.com/article/30-under-30-2024/anupam-pedarla-and-sashank-reddy-gujjula-bridging-the-gap/91651/1"
                  target="_blank"
                  className="read-more-container track-button w-inline-block"
                >
                  <div className="read-more-tex">Read Article</div>
            ...
            <div className="mask-slide w-slide">
              <div className="each-card-container">
                <div className="date-compaine-container">
                  <div className="w-embed">
                    <img
                      src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Home/the-week-logo.png"
                      alt="video-testimonials"
                      width={147}
                      height={40}
                      loading="lazy"
                  ...
                  <div className="date">16 Feb 2024</div>
                </div>
                <div className="w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/the-week-article.png"
                    alt="video-testimonials"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="card-description">
                  Nxtwave founders earn the prestigious Forbes India 30 under...
                </div>
                <a
                  id="the-week-30-under-30nxtwave-in-media"
                  rel="nofollow"
                  href="https://www.theweek.in/wire-updates/business/2024/02/16/dcm54-nxtwave.html"
                  target="_blank"
                  className="read-more-container track-button w-inline-block"
                >
                  <div className="read-more-tex">Read Article</div>
            ...
            <div className="mask-slide w-slide">
              <div className="each-card-container">
                <div className="date-compaine-container">
                  <div className="w-embed">
                    <img
                      src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Home/economic-times-logo.png"
                      alt="video-testimonials"
                      width={160}
                      height={40}
                      loading="lazy"
                ...
                <div className="w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/economic-times-article.png"
                    alt="video-testimonials"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <a
                  id="economic-times-fundingnxtwave-in-media"
                  rel="nofollow"
            ...
            <div className="mask-slide w-slide">
              <div className="each-card-container">
                <div className="date-compaine-container">
                  <div className="html-embed-82631 w-embed">
                    <img
                      src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Home/your-story-logo.png"
                      width={147}
                      height={40}
                      loading="lazy"
                    />
                ...
                <div className="w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/financial-express-article.png"
                    alt="video-testimonials"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="card-description">
                  Edtech startup Nxtwave raises $33M in series a round led by...
                </div>
                <a
                  id="yourstory-fundingnxtwave-in-media"
                  rel="nofollow"
                  href="https://yourstory.com/2023/02/edtech-startup-nxtwave-series-a-funding-greater-pacific-capital"
                  target="_blank"
                  className="read-more-container track-button w-inline-block"
                >
                  <div className="read-more-tex">Read Article</div>
            ...
            <div className="mask-slide w-slide">
              <div className="each-card-container">
                <div className="date-compaine-container">
                  <div className="html-embed-82631 w-embed">
                    <img
                      src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Home/financial-express-logo.png"
                      width={147}
                      height={40}
                      loading="lazy"
                    />
                  </div>
                  <div className="date">17 April 2023</div>
                </div>
                <div className="w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/apis-partnership-logo.png"
                    alt="video-testimonials"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="card-description">
                  APIS partners with NxtWave Disruptive Technologies to enhan...
                </div>
                <a
                  id="financial-express-apis-partnerednxtwave-in-media"
                  rel="nofollow"
                  href="https://www.financialexpress.com/jobs-career/education-apis-partners-with-nxtwave-disruptive-technologies-to-enhance-startup-ecosystem-in-ap-3050509/"
                  target="_blank"
                  className="read-more-container track-button w-inline-block"
                >
                  <div className="read-more-tex">Read Article</div>
            ...
            <div className="mask-slide w-slide">
              <div className="each-card-container">
                <div className="date-compaine-container">
                  <div className="w-embed">
                    <img
                      src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Home/the-print-logo.png"
                      alt="video-testimonials"
                      width={145}
                      height={45}
                      loading="lazy"
                  ...
                  <div className="date">03 May 2023</div>
                </div>
                <div className="w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/companies-count-article.png"
                    alt="video-testimonials"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="card-description">
                  1,500 Companies Hire NxtWave Graduates as the Startup...
                </div>
                <a
                  id="the-print-comapnies-hirednxtwave-in-media"
                  rel="nofollow"
                  href="https://theprint.in/ani-press-releases/1500-companies-hire-nxtwave-graduates-as-the-startup-continues-to-revolutionize-the-tech-employment-landscape/1734478/"
                  target="_blank"
                  className="read-more-container track-button w-inline-block"
                >
                  <div className="read-more-tex">Read Article</div>
            ...
            <div className="mask-slide w-slide">
              <div className="each-card-container">
                <div className="date-compaine-container">
                  ...
                  <div className="date">13 Sep 2023</div>
                </div>
                <div className="w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/gen-ai-article.png"
                    alt="video-testimonials"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="card-description">
                  NxtWave aims to empower tech students with Generative AI...
                </div>
                <a
                  id="financial-express-gen-ainxtwave-in-media"
                  rel="nofollow"
                  href="https://www.financialexpress.com/jobs-career/education-nxtwave-aims-to-empower-tech-students-with-generative-ai-workshop-on-world-youth-skills-day-3170269/"
                  target="_blank"
                  className="read-more-container track-button w-inline-block"
                >
                  <div className="read-more-tex">Read Article</div>
            ...
            <div className="mask-slide w-slide">
              <div className="each-card-container">
                <div className="date-compaine-container">
                  <div className="w-embed">
                    <img
                      src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Home/cxo-logo.png"
                      alt="media-spotlight"
                      width={147}
                      height={40}
                      loading="lazy"
                  ...
                  <div className="date">30 Nov 2023</div>
                </div>
                <div className="w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/startup-spotlight-article.png"
                    alt="media-spotlight"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="card-description">
                  NxtWave Awarded the Startup Spotlight Award by T-Hub
                </div>
                <a
                  id="cxotoday-t-hubnxtwave-in-media"
                  rel="nofollow"
                  href="https://cxotoday.com/press-release/nxtwave-awarded-the-startup-spotlight-award-by-t-hub/"
                  target="_blank"
                  className="read-more-container track-button w-inline-block"
                >
                  <div className="read-more-tex">Read Article</div>
            ...
            <div className="mask-slide w-slide">
              <div className="each-card-container">
                <div className="date-compaine-container">
                  ...
                  <div className="date">10 April 2023</div>
                </div>
                <div className="w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/dubai-camp-article.png"
                    alt="media-spotlight"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="card-description">
                  NxtWave hosts 4-day ‘4.0 Tech Camp’ in Dubai to upskill
                  students...
                </div>
                <a
                  id="financial-express-dubai-4.0-campnxtwave-in-media"
                  rel="nofollow"
                  href="https://www.financialexpress.com/jobs-career/education-nxtwave-hosts-4-day-4-0-tech-camp-in-dubai-to-upskill-students-in-emerging-technologies-3041040/"
                  target="_blank"
                  className="read-more-container track-button w-inline-block"
                >
                  <div className="read-more-tex">Read Article</div>
            ...
            <div className="mask-slide w-slide">
              <div className="each-card-container">
                <div className="date-compaine-container">
                  <div className="w-embed">
                    <img
                      src="https://nxtwave.imgix.net/ccbp-website/Home/csr-mandate-logo.png"
                      alt="media-spotlight"
                      width={145}
                      height={40}
                      loading="lazy"
                  ...
                  <div className="date">05 Oct 2023</div>
                </div>
                <div className="w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/csr-mandate-article.png"
                    alt="media-spotlight"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="card-description">
                  NxtWave Marks Impactful CSR Initiatives and Blood Donation...
                </div>
                <a
                  id="csr-mandate-blood-donationnxtwave-in-media"
                  rel="nofollow"
                  href="https://www.csrmandate.org/nxtwave-marks-impactful-csr-initiatives-and-blood-donation-drive/"
                  target="_blank"
                  className="read-more-container track-button w-inline-block"
                >
                  <div className="read-more-tex">Read Article</div>
            ...
            <div className="mask-slide w-slide">
              <div className="each-card-container">
                <div className="date-compaine-container">
                  <div className="w-embed">
                    <img
                      src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Home/business-week-logo.png"
                      alt="media-spotlight"
                      width={145}
                      height={40}
                      loading="lazy"
                ...
                <div className="w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/ministry-recognision-article.png"
                    width="100%"
                    loading="lazy"
                  />
                </div>
                <div className="card-description">
                  NxtWave Graduates Shine at the 2nd Kaushal Deekshant
                  Samaroh...
                </div>
                <a
                  id="business-week-award-from-ministrynxtwave-in-media"
                  rel="nofollow"
                  href="https://businessnewsthisweek.com/business/nxtwave-graduates-shine-at-the-2nd-kaushal-deekshant-samaroh-new-delhi/#google_vignette"
                  target="_blank"
                  className="read-more-container track-button w-inline-block"
                >
                  <div className="read-more-tex">Read Article</div>
            ...
            <div className="mask-slide w-slide">
              <div className="each-card-container">
                <div className="date-compaine-container">
                  ...
                  <div className="date">26 Sep 2023</div>
                </div>
                <div className="w-embed">
                  <img
                    src="https://nxtwave.imgix.net/ccbp-website/Home/ethical-hacking-logo.png"
                    alt="media-spotlight"
                    width="100%"
                    loading="lazy"
                  />
                ...
                <div className="card-description">
                  NxtWave to host workshop on ‘Ethical Hacking – Building
                  India’s..
                </div>
                <a
                  id="financial-express-ethical-hackingnxtwave-in-media"
                  rel="nofollow"
                  href="https://www.financialexpress.com/jobs-career/education-nxtwave-to-host-workshop-on-ethical-hacking-building-indias-cyber-army-3255252/"
                  target="_blank"
                  className="read-more-container track-button w-inline-block"
                >
                  <div className="read-more-tex">Read Article</div>
          ...
          <div
            id="left-arrow-nxtwave-in-media"
            className="nxtwave-media-slider-left-arrow track-button w-slider-arrow-left"
          >
            <div className="spotlight-slider-left-arrow-2" />
          </div>
          <div
            id="right-arrow-nxtwave-in-media"
            className="nxtwave-media-slider-right-arrow track-button w-slider-arrow-right"
          >
            <div className="spotlight-slider-right-arrow-2" />
          </div>
          <div className="slide-nav-18-copy display-block-copy w-slider-nav" />
        </div>
      </div>
    </div>
  </section>
  <div id="footer" data-sectionid="sections" className="section-137">
    <div>
      <div className="container-24">
        <div className="footer-row-3">
          <div className="footer-info-2">
            <a
              ...
              id="footer-nxtwave-logo"
              className="footer-logo-link-2 track-button w-inline-block"
            >
              <div className="nxtwave-white-logo-2 w-embed">
                <style
                  dangerouslySetInnerHTML={{
          ...
          <div className="footer-menus-row-2">
            <div className="div-block-1904">
              <h6 className="h6-small-2 quicklinks">Quick Links</h6>
              <div className="div-block-1911">
                <div className="footer-menu-column-3">
                  <ul role="list" className="link-menu-2 links w-list-unstyled">
                    ...
                    <li className="link-menu-item-2">
                      <a
                        href="https://www.ccbp.in/contact-us"
                    ...
                    <li className="link-menu-items-22">
                      <a
                        href="https://www.ccbp.in/blog"
                        id="footer-blog"
                        className="footer-link-3 track-button"
                      >
                        Blog
                ...
                <div className="div-block-1908">
                  <ul
                    role="list"
                    className="link-menu-2 links _2nd w-list-unstyled"
                  >
                    <li className="link-menu-item-2">
                      <a
                    ...
                    <li className="link-menu-item-2">
                      <a
                        href="https://www.ccbp.in/year-end-review-2022"
                        id="footer-nxtwave-year-end-review"
                        className="footer-link-3 track-button"
                      >
                        NxtWave'22 Review
                      </a>
                    ...
                    <li className="link-menu-item-2">
                      <a
                        href="https://www.ccbp.in/blog/python-tutorial"
                        id="footer-python-tutorial"
                        className="footer-link-3 track-button"
                      >
                        Python Tutorial
                      </a>
            ...
            <div className="footer-menu-column-3 reachus email">
              <h6 className="h6-small-2">Payment Methods</h6>
              <div className="div-block-1912">
                <div
                  id="w-node-_0b7bf02e-928f-b167-4694-3955e233b0fb-5c75ea4e"
                  className="payment-imgs w-embed"
                >
                  <img
                    src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Home/visa-icon.svg"
                    alt="payment method"
                    loading="lazy"
                  />
                </div>
                <div
                  id="w-node-_23b5fcd5-3a03-fae3-7c63-7fc79f400fce-5c75ea4e"
                  className="payment-imgs w-embed"
                >
                  <img
                    src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Home/master-card-icon.svg"
                    alt="payment method"
                    loading="lazy"
                  />
                </div>
                <div
                  id="w-node-be142f15-7672-17ec-96b3-e3b98483875b-5c75ea4e"
                  className="payment-imgs w-embed"
                >
                  <img
                    src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Home/payment-method-icon.svg"
                    alt="payment method"
                    loading="lazy"
                  />
                </div>
                <div
                  id="w-node-dbb848d6-9043-4126-44db-01a50f818adb-5c75ea4e"
                  className="payment-imgs w-embed"
                >
                  <img
                    src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Home/Razor-pay-icon.svg"
                    alt="payment method"
                    loading="lazy"
                  />
                </div>
                <div
                  id="w-node-dfe2dbad-02ac-2352-0586-fdac016eb89c-5c75ea4e"
                  className="payment-imgs w-embed"
                >
                  <img
                    src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Home/upi-icon.svg"
                    alt="payment method"
                    loading="lazy"
                  />
                </div>
                <div
                  id="w-node-_03166f1d-fefc-c243-91ff-b32fd01e206e-5c75ea4e"
                  className="payment-imgs w-embed"
                >
                  <img
                    src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Home/rupay-icon.svg"
                    alt="payment method"
                    loading="lazy"
                  />
                </div>
              </div>
              <div className="div-block-1909">
                <div className="div-block-1831980521422">
        ...
        <div className="div-block-1907">
          <div className="div-block-1371">
            <a
            ...
            >
              <div className="image-762 w-embed">
                <img
                  src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Home/facebook-icon.svg"
                  alt="socal media"
                  loading="lazy"
                />
              </div>
            ...
            >
              <div className="image-762 w-embed">
                <img
                  src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Home/instgram-icon.svg"
                  alt="socal media"
                  loading="lazy"
                />
              </div>
            ...
            >
              <div className="image-762 w-embed">
                <img
                  src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Home/twitterimage.svg"
                  alt="socal media"
                  loading="lazy"
                />
              </div>
            ...
            >
              <div className="image-762 w-embed">
                <img
                  src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Home/linkedin-icon.svg"
                  alt="socal media"
                  loading="lazy"
                />
              </div>
            ...
            >
              <div className="image-762 w-embed">
                <img
                  src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Home/youtube-icon.svg"
                  alt="socal media"
                  loading="lazy"
                />
              </div>
          ...
          <div className="div-block-1906">
            <div className="div-block-183198052143944">
              ...
              <div className="gr-footer-copy-copy">
                <a
                  href="https://www.ccbp.in/corporate-information"
                  id="footer-corporate-information"
                  className="link-73 track-button"
                >
              ...
              >
                <a
                  href="https://www.ccbp.in/vision-and-values"
                  id="footer-vision-and-value"
                  className="link-87 track-button"
                >
                  Vision and Values
                </a>
                <br />
        ...
        <div id="course-track">
          ...
          <div className="div-block-183198052143954">
            <div className="div-block-183198052143957">
              <a
                id="footer-mern-stack-developer-course-track"
                href="https://www.ccbp.in/intensive/mern-stack-developer-course"
                className="link-110 size-h track-button"
              >
            ...
            <div className="div-block-183198052143957">
              <a
                id="footer-full-stack-developer-course-track"
                href="https://www.ccbp.in/intensive/full-stack-developer-course"
                className="link-110 size-h track-button"
              >
                Full Stack Developer course
              </a>
              <div className="div-block-183198052143956">
                <div className="fsd-cites">
                  <a
                    id="footer-full-stack-developer-course-hyderabad-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-hyderabad"
                    className="link-110 size-p track-button"
                  >
                    Hyderabad
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-full-stack-developer-course-bangalore-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-bangalore"
                    className="link-110 size-p track-button"
                  >
                    Bangalore
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-full-stack-developer-course-pune-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-pune"
                    className="link-110 size-p track-button"
                  >
                    Pune
                  </a>
                  <div className="text-block-9412881958 mb-hide">|</div>
                  <a
                    id="footer-full-stack-developer-course-mumbai-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-mumbai"
                    className="link-110 size-p track-button"
                  >
                    Mumbai
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-full-stack-developer-course-delhi-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-delhi"
                    className="link-110 size-p track-button"
                  >
                    Delhi
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-full-stack-developer-course-ahmedabad-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-ahmedabad"
                    className="link-110 size-p track-button"
                  >
                    Ahmedabad
                  </a>
                  <div className="text-block-9412881958 mb-hide">|</div>
                  <a
                    id="footer-full-stack-developer-course-coimbatore-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-coimbatore"
                    className="link-110 size-p track-button"
                  >
                    Coimbatore
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-full-stack-developer-course-chennai-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-chennai"
                    className="link-110 size-p track-button"
                  >
                    Chennai
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-full-stack-developer-course-chandigarh-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-chandigarh"
                    className="link-110 size-p track-button"
                  >
                    Chandigarh
                  </a>
                  <div className="text-block-9412881958 mb-hide">|</div>
                  <a
                    id="footer-full-stack-developer-course-noida-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-noida"
                    className="link-110 size-p track-button"
                  >
                    Noida
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-full-stack-developer-course-kolkata-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-kolkata"
                    className="link-110 size-p track-button"
                  >
                    Kolkata
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-full-stack-developer-course-kochi-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-kochi"
                    className="link-110 size-p track-button"
                  >
                    Kochi&nbsp;&nbsp;
                  </a>
                  <div className="text-block-9412881958 ds-hide mb-hide">|</div>
                  <a
                    id="footer-full-stack-developer-course-bhubaneswar-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-bhubaneswar"
                    className="link-110 size-p track-button"
                  >
                    Bhubaneswar
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-full-stack-developer-course-visakhapatnam-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-visakhapatnam"
                    className="link-110 size-p track-button"
                  >
                    Visakhapatnam
                  </a>
                  <div className="text-block-9412881958 mb-hide">|</div>
                  <a
                    id="footer-full-stack-developer-course-vijayawada-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-vijayawada"
                    className="link-110 size-p track-button"
                  >
                    Vijayawada
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-full-stack-developer-course-gurgaon-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-gurgaon"
                    className="link-110 size-p track-button"
                  >
                    Gurgaon
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-full-stack-developer-course-jaipur-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-jaipur"
                    className="link-110 size-p track-button"
                  >
                    Jaipur&nbsp;&nbsp;
                  </a>
                  <div className="text-block-9412881958 mb-hide">|</div>
                  <a
                    id="footer-full-stack-developer-course-indore-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-indore"
                    className="link-110 size-p track-button"
                  >
                    Indore
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-full-stack-developer-course-kanpur-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-kanpur"
                    className="link-110 size-p track-button"
                  >
                    Kanpur
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-full-stack-developer-course-nagpur-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-nagpur"
                    className="link-110 size-p track-button"
                  >
                    Nagpur
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-full-stack-developer-course-madurai-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-madurai"
                    className="link-110 size-p track-button"
                  >
                    Madurai
                  </a>
                  <div className="text-block-9412881958 mb-hide">|</div>
                  <a
                    id="footer-full-stack-developer-course-bhopal-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-bhopal"
                    className="link-110 size-p track-button"
                  >
                    Bhopal
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-full-stack-developer-course-trivandrum-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-trivandrum"
                    className="link-110 size-p track-button"
                  >
                    Trivandrum
                  </a>
                  <div className="text-block-9412881958 ds-hide">|</div>
                  <a
                    id="footer-full-stack-developer-course-guwahati-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-guwahati"
                    className="link-110 size-p track-button"
                  >
                    Guwahati
                  </a>
                  <div className="text-block-9412881958 mb-hide">|</div>
                  <a
                    id="footer-full-stack-developer-course-patna-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-patna"
                    className="link-110 size-p track-button"
                  >
                    Patna&nbsp;&nbsp;
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-full-stack-developer-course-aurangabad-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-aurangabad"
                    className="link-110 size-p track-button"
                  >
                    Aurangabad&nbsp;
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-full-stack-developer-course-trichy-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-trichy"
                    className="link-110 size-p track-button"
                  >
                    Trichy &nbsp;
                  </a>
                  <div className="text-block-9412881958 mb-hide">|</div>
                  <a
                    id="footer-full-stack-developer-course-salem-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-salem"
                    className="link-110 size-p track-button"
                  >
                    Salem
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-full-stack-developer-course-thane-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-thane"
                    className="link-110 size-p track-button"
                  >
                    Thane
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-full-stack-developer-course-kerala-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-kerala"
                    className="link-110 size-p track-button"
                  >
                    Kerala
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-full-stack-developer-course-mysore-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-mysore"
                    className="link-110 size-p track-button"
                  >
                    Mysore
                  </a>
                  ...
                  <div className="text-block-9412881958 ds-hide mb-hide">|</div>
                  <a
                    id="footer-full-stack-developer-course-telugu-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-telugu"
                    className="link-110 size-p track-button"
                  >
                    Telugu
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-full-stack-developer-course-tamil-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-tamil"
                    className="link-110 size-p track-button"
                  >
                    Tamil
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-full-stack-developer-course-hindi-track"
                    href="https://www.ccbp.in/intensive/full-stack-developer-course-in-hindi"
                    className="link-110 size-p track-button"
                  >
                    Hindi
                  </a>
            ...
            <div className="div-block-183198052143957">
              <a
                id="footer-data-analyst-course-track"
                href="https://www.ccbp.in/intensive/data-analyst-course"
                className="link-110 size-h track-button"
              >
                Data Analytics course
              </a>
              <div className="div-block-183198052144022">
                <div className="da-cities">
                  <a
                    id="footer-data-analytics-course-hyderabad-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-hyderabad"
                    className="link-110 size-p track-button"
                  >
                    Hyderabad
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-data-analytics-course-bangalore-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-bangalore"
                    className="link-110 size-p track-button"
                  >
                    Bangalore
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-data-analytics-course-pune-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-pune"
                    className="link-110 size-p track-button"
                  >
                    Pune
                  </a>
                  <div className="text-block-9412881958 mb-hide">|</div>
                  <a
                    id="footer-data-analytics-course-mumbai-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-mumbai"
                    className="link-110 size-p track-button"
                  >
                    Mumbai
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-data-analytics-course-delhi-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-delhi"
                    className="link-110 size-p track-button"
                  >
                    Delhi
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-data-analytics-course-chennai-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-chennai"
                    className="link-110 size-p track-button"
                  >
                    Chennai
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-data-analytics-course-kolkata-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-kolkata"
                    className="link-110 size-p track-button"
                  >
                    Kolkata
                  </a>
                  <div className="text-block-9412881958 mb-hide">|</div>
                  <a
                    id="footer-data-analytics-course-chandigarh-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-chandigarh"
                    className="link-110 size-p track-button"
                  >
                    Chandigarh
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-data-analytics-course-ahmedabad-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-ahmedabad"
                    className="link-110 size-p track-button"
                  >
                    Ahmedabad
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-data-analytics-course-coimbatore-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-coimbatore"
                    className="link-110 size-p track-button"
                  >
                    Coimbatore
                  </a>
                  <div className="text-block-9412881958 mb-hide">|</div>
                  <a
                    id="footer-data-analytics-course-gurgaon-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-gurgaon"
                    className="link-110 size-p track-button"
                  >
                    Gurgaon &nbsp;
                  </a>
                  <div className="text-block-9412881958 ds-hide">|</div>
                  <a
                    id="footer-data-analytics-course-noida-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-noida"
                    className="link-110 size-p track-button"
                  >
                    Noida
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-data-analytics-course-kerala-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-kerala"
                    className="link-110 size-p track-button"
                  >
                    Kerala
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-data-analytics-course-nagpur-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-nagpur"
                    className="link-110 size-p track-button"
                  >
                    Nagpur
                  </a>
                  <div className="text-block-9412881958 mb-hide">|</div>
                  <a
                    id="footer-data-analytics-course-indore-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-indore"
                    className="link-110 size-p track-button"
                  >
                    Indore
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-data-analytics-course-jaipur-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-jaipur"
                    className="link-110 size-p track-button"
                  >
                    Jaipur
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-data-analytics-course-lucknow-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-lucknow"
                    className="link-110 size-p track-button"
                  >
                    Lucknow
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-data-analytics-course-thane-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-thane"
                    className="link-110 size-p track-button"
                  >
                    Thane
                  </a>
                  <div className="text-block-9412881958 mb-hide">|</div>
                  <a
                    id="footer-data-analytics-course-bhopal-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-bhopal"
                    className="link-110 size-p track-button"
                  >
                    Bhopal
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-data-analytics-course-dehradun-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-dehradun"
                    className="link-110 size-p track-button"
                  >
                    Dehradun
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-data-analytics-course-bhubaneswar-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-bhubaneswar"
                    className="link-110 size-p track-button"
                  >
                    Bhubaneswar
                  </a>
                  <div className="text-block-9412881958 mb-hide">|</div>
                  <a
                    id="footer-data-analytics-course-mysore-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-mysore"
                    className="link-110 size-p track-button"
                  >
                    Mysore
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-data-analytics-course-vadodara-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-vadodara"
                    className="link-110 size-p track-button"
                  >
                    Vadodara
                  </a>
                  <div className="text-block-9412881958 ds-hide">|</div>
                  <a
                    id="footer-data-analytics-course-kanpur-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-kanpur"
                    className="link-110 size-p track-button"
                  >
                    Kanpur
                  </a>
                  <div className="text-block-9412881958 mb-hide">|</div>
                  <a
                    id="footer-data-analytics-course-trivandrum-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-trivandrum"
                    className="link-110 size-p track-button"
                  >
                    Trivandrum
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-data-analytics-course-surat-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-surat"
                    className="link-110 size-p track-button"
                  >
                    Surat
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-data-analytics-course-nashik-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-nashik"
                    className="link-110 size-p track-button"
                  >
                    Nashik&nbsp;{" "}
                  </a>
                  <div className="text-block-9412881958 mb-hide">|</div>
                  <a
                    id="footer-data-analytics-course-madurai-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-madurai"
                    className="link-110 size-p track-button"
                  >
                    Madurai &nbsp;&nbsp;
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-data-analytics-course-patna-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-patna"
                    className="link-110 size-p track-button"
                  >
                    Patna
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-data-analytics-course-aurangabad-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-aurangabad"
                    className="link-110 size-p track-button"
                  >
                    Aurangabad
                  </a>
                  <div className="text-block-9412881958 mb-hide">|</div>
                  <a
                    id="footer-data-analytics-course-ghaziabad-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-ghaziabad"
                    className="link-110 size-p track-button"
                  >
                    Ghaziabad
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-data-analytics-course-meerut-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-meerut"
                    className="link-110 size-p track-button"
                  >
                    Meerut
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-data-analytics-course-guwahati-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-guwahati"
                    className="link-110 size-p track-button"
                  >
                    Guwahati
                  </a>
                  <div className="text-block-9412881958 mb-hide">|</div>
                  <a
                    id="footer-data-analytics-course-kolhapur-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-kolhapur"
                    className="link-110 size-p track-button"
                  >
                    Kolhapur
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-data-analytics-course-kochi-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-kochi"
                    className="link-110 size-p track-button"
                  >
                    Kochi
                  </a>
                  <div className="text-block-9412881958 ds-hide">|</div>
                  <a
                    id="footer-data-analytics-course-trichy-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-trichy"
                    className="link-110 size-p track-button"
                  >
                    Trichy
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-data-analytics-course-telugu-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-telugu"
                    className="link-110 size-p track-button"
                  >
                    Telugu
                  </a>
                  <div className="text-block-9412881958 mb-hide">|</div>
                  <a
                    id="footer-data-analytics-course-tamil-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-tamil"
                    className="link-110 size-p track-button"
                  >
                    Tamil
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-data-analytics-course-hindi-track"
                    href="https://www.ccbp.in/intensive/data-analyst-course-in-hindi"
                    className="link-110 size-p track-button"
                  >
                    Hindi
                  </a>
            ...
            <div className="div-block-183198052143957">
              <a
                id="footer-automtation-testing-course-track"
                href="https://www.ccbp.in/intensive/automation-testing-course"
                className="link-110 size-h track-button"
              >
                QA / Automation Testing course
              </a>
              <div className="div-block-183198052143956">
                <div className="div-block-183198052143955">
                  <a
                    id="footer-automation-testing-course-bangalore-track"
                    href="https://www.ccbp.in/intensive/automation-testing-course-in-bangalore"
                    className="link-110 size-p track-button"
                  >
                    Bangalore
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-automation-testing-course-hyderabad-track"
                    href="https://www.ccbp.in/intensive/automation-testing-course-in-hyderabad"
                    className="link-110 size-p track-button"
                  >
                    Hyderabad
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-automation-testing-course-chennai-track"
                    href="https://www.ccbp.in/intensive/automation-testing-course-in-chennai"
                    className="link-110 size-p track-button"
                  >
                    Chennai
                  </a>
                  <div className="text-block-9412881958 mb-hide">|</div>
                  <a
                    id="footer-automation-testing-course-pune-track"
                    href="https://www.ccbp.in/intensive/automation-testing-course-in-pune"
                    className="link-110 size-p track-button"
                  >
                    Pune
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-automation-testing-course-coimbatore-track"
                    href="https://www.ccbp.in/intensive/automation-testing-course-in-coimbatore"
                    className="link-110 size-p track-button"
                  >
                    Coimbatore
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-automation-testing-course-noida-track"
                    href="https://www.ccbp.in/intensive/automation-testing-course-in-noida"
                    className="link-110 size-p track-button"
                  >
                    Noida
                  </a>
                  <div className="text-block-9412881958 mb-hide">|</div>
                  <a
                    id="footer-automation-testing-course-telugu-track"
                    href="https://www.ccbp.in/intensive/software-automation-testing-course-in-telugu"
                    className="link-110 size-p track-button"
                  >
                    Telugu
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-automation-testing-course-tamil-track"
                    href="https://www.ccbp.in/intensive/software-automation-testing-course-in-tamil"
                    className="link-110 size-p track-button"
                  >
                    Tamil
                  </a>
                  <div className="text-block-9412881958">|</div>
                  <a
                    id="footer-automation-testing-course-hindi-track"
                    href="https://www.ccbp.in/intensive/software-automation-testing-course-in-hindi"
                    className="link-110 size-p track-button"
                  >
                    Hindi
                  </a>
  ...
  <div
    id="chat-with-us-div"
    className="home-page-whatsappdiv intensive-2-0page"
  >
    <a
    ...
    >
      ...
      <div className="html-embed-84 w-embed">
        <img
          src="https://nxtwave-website-media-files.s3.ap-south-1.amazonaws.com/ccbp-website/Intensive+2.0/intensive-whatsapp-logo.png"
          width={48}
          height={48}
          laoding="lazy"
        />
  ...
  <noscript>
    &lt;iframe rel="nofollow"
    src="https://www.googletagmanager.com/ns.html?id=GTM-KPFWFTR" height="0"
